import {
  ...
  themes,
  toPx
} from "./chunk-EL44BTGL.js";
import {
  require_react_fast_compare
} from "./chunk-SGHH5WPS.js";
import {
  CSSTransition_default,
  TransitionGroup_default,
  Transition_default
} from "./chunk-G7RRJHTF.js";
import {
  SvgAlertCircleIcon,
  SvgAlertDiamondIcon,
...
function useMediaQuery(queryOrAlias, options = {}) {
  ...
  const getMatches = (0, import_react9.useCallback)((query2) => {
...
var SelectionType = (function(SelectionType3) {
...
function useBreakpoints(options) {
  const [breakpoints, setBreakpoints] = (0, import_react11.useState)(getDefaultMatches(options?.defaults));
  useIsomorphicLayoutEffect(() => {
...
var MediaQueryProvider = function MediaQueryProvider2({
  ...
  const [isNavigationCollapsed, setIsNavigationCollapsed] = (0, import_react19.useState)(false);
...
function PortalsManager({
  ...
  return import_react23.default.createElement(PortalsManagerContext.Provider, {
    value: contextValue
  }, children, container ? null : import_react23.default.createElement(PortalsContainer, {
    ref
  }));
}
...
var AppProvider = class extends import_react28.Component {
  ...
  render() {
    ...
    return import_react28.default.createElement(ThemeNameContext.Provider, {
      ...
      value: link
    }, import_react28.default.createElement(MediaQueryProvider, null, import_react28.default.createElement(PortalsManager, null, import_react28.default.createElement(FocusManager, null, import_react28.default.createElement(EphemeralPresenceManager, null, children)))))))))));
  }
};
...
function Spinner({
  ...
  const spinnerSVGMarkup = size === "large" ? import_react31.default.createElement("svg", {
    viewBox: "0 0 44 44",
...
function UnstyledButton({
  ...
  if (url) {
    buttonMarkup = disabled ? (
      ...
      import_react35.default.createElement("a", commonProps, children)
...
function Button({
  ...
  const childMarkup = children ? import_react37.default.createElement(Text, {
    as: "span",
    variant: textVariant,
...
function SettingAction({
  ...
  }, children), import_react42.default.createElement("div", {
...
function Avatar({
  ...
  const className = classNames(styles11.Avatar, size && styles11[variationName("size", size)], hasImage && status === Status.Loaded && styles11.imageHasLoaded, !customer && !hasImage && styles11[variationName("style", styleClass(nameString))]);
  const textClassName = classNames(styles11.Text, (initials?.length || 0) > 2 && styles11.long);
...
var ToneValue = (function(ToneValue2) {
...
var ProgressValue = (function(ProgressValue2) {
...
function Badge({
  ...
  const className = classNames(styles13.Badge, tone && styles13[variationName("tone", tone)], size && size !== DEFAULT_SIZE && styles13[variationName("size", size)], withinFilter && styles13.withinFilter);
  ...
  return import_react51.default.createElement("span", {
    ...
    source: icon
  })), children && import_react51.default.createElement(Text, {
    as: "span",
    variant: "bodySm",
...
var UNIQUE_IDENTIFIER = /* @__PURE__ */ Symbol("unique_identifier");
...
var ScrollableComponent = (0, import_react60.forwardRef)(({
  ...
  const finalClassName = classNames(className, styles18.Scrollable, vertical && styles18.vertical, horizontal && styles18.horizontal, shadow && topShadow && styles18.hasTopShadow, shadow && bottomShadow && styles18.hasBottomShadow, scrollbarWidth && styles18[variationName("scrollbarWidth", scrollbarWidth)], scrollbarGutter && styles18[variationName("scrollbarGutter", scrollbarGutter.replace(" ", ""))]);
...
function TooltipOverlay({
  ...
  function renderTooltip(overlayDetails) {
    ...
    const contentClassName = classNames(styles16.Content, width && styles16[width]);
...
var TruncateText = ({
  ...
  const text = import_react64.default.createElement(Text, {
    as: "span",
    truncate: true
...
function Label({
  ...
  return import_react68.default.createElement("div", {
    className
  }, import_react68.default.createElement("label", {
    id: labelID(id),
    htmlFor: id,
...
function Labelled({
  ...
  const actionMarkup = action ? import_react69.default.createElement("div", {
    className: styles20.Action
  }, buttonFrom(action, {
    variant: "plain"
  })) : null;
  const helpTextMarkup = helpText ? import_react69.default.createElement("div", {
  ...
  const errorMarkup = error && typeof error !== "boolean" && import_react69.default.createElement("div", {
    className: styles20.Error
  }, import_react69.default.createElement(InlineError, {
    message: error,
    fieldID: id
  }));
  const labelMarkup = label ? import_react69.default.createElement("div", {
    className: styles20.LabelWrapper
  }, import_react69.default.createElement(Label, Object.assign({
    id,
    requiredIndicator
  }, rest, {
    hidden: false
...
function Connected({
  ...
  const leftConnectionMarkup = left ? import_react71.default.createElement(Item2, {
    position: "left"
  }, left) : null;
  const rightConnectionMarkup = right ? import_react71.default.createElement(Item2, {
    position: "right"
  }, right) : null;
  return import_react71.default.createElement("div", {
    className: styles23.Connected
  }, leftConnectionMarkup, import_react71.default.createElement(Item2, {
    position: "primary"
...
var Spinner2 = import_react72.default.forwardRef(function Spinner3({
  onChange,
  onClick,
  onMouseDown,
  onMouseUp,
  ...
  }, import_react72.default.createElement(Icon, {
...
function TextField({
  ...
  const i18n = useI18n();
  const [height, setHeight] = (0, import_react74.useState)(null);
  ...
  const handleExpandingResize = (0, import_react74.useCallback)((height2) => {
    setHeight(height2);
  }, []);
...
function elementChildren(children, predicate = () => true) {
  return import_react76.Children.toArray(children).filter((child) => (0, import_react76.isValidElement)(child) && predicate(child));
}
...
// node_modules/@shopify/polaris/build/esm/components/Popover/components/PopoverOverlay/PopoverOverlay.js
var PopoverCloseSource = (function(PopoverCloseSource2) {
...
var TransitionStatus = (function(TransitionStatus3) {
...
function renderPopoverContent(children, props) {
  const childrenArray = import_react79.Children.toArray(children);
...
var PopoverComponent = (0, import_react80.forwardRef)(function Popover({
  ...
  const [isDisplayed, setIsDisplay] = (0, import_react80.useState)(false);
  ...
  const portal2 = activatorNode && isDisplayed ? import_react80.default.createElement(Portal, {
    idPrefix: "popover"
...
var TextOption = (0, import_react92.memo)(function TextOption2({
  ...
  const optionMarkup = selected ? import_react92.default.createElement(Box, {
    ...
    align: "space-between",
    gap: "200"
  }, children, import_react92.default.createElement(InlineStack, {
    align: "end"
...
function Header({
  ...
  const content = typeof children === "string" ? import_react98.default.createElement(Box, {
    paddingBlockStart: "200",
...
var Option = (0, import_react100.memo)(function Option2({
  ...
  const content = typeof children === "string" ? import_react100.default.createElement(TextOption, {
    selected,
    disabled
  }, children) : children;
...
// node_modules/@shopify/polaris/build/esm/components/Listbox/Listbox.js
var AutoSelection = (function(AutoSelection2) {
...
function Listbox({
  ...
  (0, import_react102.useEffect)(() => {
    if (autoSelection !== AutoSelection.None && !loading && children && import_react102.Children.count(children) > 0) {
      resetActiveOption();
    }
  ...
  return import_react102.default.createElement(import_react102.default.Fragment, null, listeners, import_react102.default.createElement(Text, {
    ...
    value: true
  }, children ? import_react102.default.createElement("ul", {
    tabIndex: 0,
    role: "listbox",
...
function Combobox({
  ...
  const popoverActiveWithChildren = popoverActive && import_react105.Children.count(children) > 0;
  ...
  return import_react105.default.createElement(Popover2, {
    ...
    preferredPosition,
    onClose: handleClose
  }, import_react105.Children.count(children) > 0 ? import_react105.default.createElement(Popover2.Pane, {
    onScrolledToBottom,
    height,
    maxHeight,
    minHeight
...
function ButtonGroup({
  ...
  const contents = elementChildren(children).map((child, index) => import_react114.default.createElement(Item3, {
    button: child,
    key: index
  }));
...
function BannerLayout({
  ...
  const childrenMarkup = children ? import_react115.default.createElement(Text, {
    as: "span",
    variant: "bodyMd"
  }, children) : null;
...
function DefaultBanner({
  ...
  return import_react115.default.createElement(Box, {
    ...
    gap: "200"
  }, import_react115.default.createElement("div", null, children), actionButtons))));
}
function InlineIconBanner({
  ...
  return import_react115.default.createElement(Box, {
    ...
    gap: "200"
  }, import_react115.default.createElement("div", null, children), actionButtons)))), import_react115.default.createElement("div", {
    ref: dismissIconNode,
...
function WithinContentContainerBanner({
  ...
  return import_react115.default.createElement(Box, {
    ...
    gap: "050"
  }, bannerTitle, import_react115.default.createElement("div", null, children)), actionButtons))), dismissButton));
}
...
function Header2({
  ...
  const headingMarkup = actionMarkup || children ? import_react124.default.createElement(InlineStack, {
    wrap: false,
    gap: "200",
    align: "space-between",
    blockAlign: "center"
...
var LegacyCard = function LegacyCard2({
  ...
  const content = sectioned ? import_react129.default.createElement(Section4, null, children) : children;
...
function CalloutCard({
  ...
  return import_react130.default.createElement(LegacyCard, null, import_react130.default.createElement("div", {
    ...
    as: "span",
    variant: "bodyMd"
  }, import_react130.default.createElement(BlockStack, null, children)), import_react130.default.createElement("div", {
...
function ChoiceList({
  ...
  const choicesMarkup = choices.map((choice) => {
    ...
    const children = renderedChildren ? import_react132.default.createElement("div", {
...
function Collapsible({
  ...
  const [size, setSize] = (0, import_react133.useState)(0);
  ...
  const [animationState, setAnimationState] = (0, import_react133.useState)(animateIn ? "measuring" : "idle");
  const isFullyOpen = animationState === "idle" && open && isOpen;
  const isFullyClosed = animationState === "idle" && !open && !isOpen;
  const content = expandOnPrint || !isFullyClosed ? children : null;
  const vertical = variant === "block";
  const wrapperClassName = classNames(styles54.Collapsible, isFullyClosed && styles54.isFullyClosed, expandOnPrint && styles54.expandOnPrint, variant === "inline" && styles54.inline, animateIn && styles54.animateIn);
...
var Slidable = class extends import_react134.PureComponent {
  ...
  componentDidMount() {
    ...
    this.observer = new ResizeObserver(() => {
      ...
      if (window2 !== this.node?.ownerDocument.defaultView) {
        this.setState({
...
var TruncatedText = ({
  ...
  const text = import_react142.default.createElement("span", {
    ref: textRef,
    className
  }, children);
  return current?.scrollWidth > current?.offsetWidth ? import_react142.default.createElement(Tooltip, {
...
var EditableTarget = (function(EditableTarget2) {
...
var DataTableInner = class extends import_react148.PureComponent {
  ...
  render() {
    ...
    }))), totals && showTotalsInFooter && import_react148.default.createElement("tfoot", null, import_react148.default.createElement("tr", null, nthTotals?.map((total, index) => this.renderTotals({
      total,
      index
    })))));
...
function FileUpload(props) {
  ...
  const fileUploadClassName = classNames(styles63.FileUpload, measuring && styles63.measuring, size === "large" && styles63.large, size === "small" && styles63.small);
...
var DropZone = function DropZone2({
  ...
  const [size, setSize] = (0, import_react157.useState)("large");
  ...
  const document2 = isServer ? null : node.current?.ownerDocument || globalThis.document;
  const handleDragLeave = (0, import_react157.useCallback)((event) => {
    event.preventDefault();
    if (disabled) return;
    dragTargets.current = dragTargets.current.filter((el) => {
      const compareNode = dropOnPage && !isServer ? document2 : node.current;
  ...
  }, [disabled, onDragLeave, dropOnPage, document2]);
  const dropNode = dropOnPage && !isServer ? document2 : node.current;
  ...
  function overlayMarkup(icon, text, color) {
    return import_react157.default.createElement("div", {
      ...
      gap: "200",
      inlineAlign: "center"
    }, size === "small" && import_react157.default.createElement(Icon, {
      source: icon,
      tone: color
    }), (size === "medium" || size === "large") && import_react157.default.createElement(Text, {
      variant: "bodySm",
      as: "p",
      fontWeight: "bold"
    }, text)));
...
function EmptyState({
  ...
  const imageRef = (0, import_react159.useRef)(null);
  ...
  const childrenMarkup = children ? import_react159.default.createElement(Text, {
    as: "span",
    alignment: "center",
    variant: "bodySm"
  }, children) : null;
  const textContentMarkup = headingMarkup || children ? import_react159.default.createElement(Box, {
    paddingBlockEnd: "400"
...
function FiltersBar({
  ...
  const clearAllMarkup = appliedFilters?.length ? import_react165.default.createElement("div", {
...
function Item5({
  ...
  return children ? import_react170.default.createElement("div", {
    className
  }, children) : null;
}
...
function Group({
  ...
  const itemsMarkup = import_react171.Children.map(children, (child) => wrapWithComponent(child, Item5, {
    condensed
  }));
...
var FormLayout = (0, import_react172.memo)(function FormLayout2({
  ...
  return import_react172.default.createElement(BlockStack, {
    gap: "400"
  }, import_react172.Children.map(children, wrapChildren));
});
...
function useMediaQuery2() {
  const mediaQuery = (0, import_react173.useContext)(MediaQueryContext);
  if (!mediaQuery) {
...
function Loading2() {
  ...
  const [progress, setProgress] = (0, import_react175.useState)(0);
  const [animating, setAnimating] = (0, import_react175.useState)(false);
...
// node_modules/@shopify/polaris/build/esm/components/Frame/components/CSSAnimation/CSSAnimation.js
var TransitionStatus2 = (function(TransitionStatus3) {
  TransitionStatus3["Entering"] = "entering";
  TransitionStatus3["Entered"] = "entered";
  TransitionStatus3["Exiting"] = "exiting";
  TransitionStatus3["Exited"] = "exited";
...
function CSSAnimation({
  ...
  const [transitionStatus, setTransitionStatus] = (0, import_react176.useState)(inProp ? TransitionStatus2.Entering : TransitionStatus2.Exited);
  const isMounted = (0, import_react176.useRef)(false);
  const node = (0, import_react176.useRef)(null);
...
function Section5({
  ...
  return import_react177.default.createElement("div", {
    className
  }, import_react177.default.createElement(Box, Object.assign({
    as: "section",
    padding: flush ? "0" : "400"
  }, titleHidden && {
    paddingInlineEnd: "0"
...
function useFocusManager({
  ...
  const focusManager = (0, import_react178.useContext)(FocusManagerContext);
  const id = (0, import_react178.useId)();
  if (!focusManager) {
  ...
  const value = (0, import_react178.useMemo)(() => ({
    canSafelyFocus
  }), [canSafelyFocus]);
...
function TrapFocus({
  ...
  const focusTrapWrapper = (0, import_react179.useRef)(null);
  const [disableFocus, setDisableFocus] = (0, import_react179.useState)(true);
  ...
  return import_react179.default.createElement(Focus, {
    disabled: disableFocus,
    root: focusTrapWrapper.current
  }, import_react179.default.createElement("div", {
    ref: focusTrapWrapper
  }, import_react179.default.createElement(EventListener, {
    event: "focusin",
    handler: handleFocusIn
  }), import_react179.default.createElement(KeypressListener, {
    keyCode: Key.Tab,
    keyEvent: "keydown",
    handler: handleTab
  }), children));
...
function Dialog({
  ...
  const theme = useTheme();
  const containerNode = (0, import_react180.useRef)(null);
  const frameContext = (0, import_react180.useContext)(FrameContext);
  let toastMessages;
  if (frameContext) {
    toastMessages = frameContext.toastMessages;
  }
  const classes = classNames(styles77.Modal, size && styles77[variationName("size", size)], limitHeight && styles77.limitHeight);
  ...
  const ariaLiveAnnouncements = import_react180.default.createElement("div", {
    "aria-live": "assertive"
  }, toastMessages ? toastMessages.map((toastMessage) => import_react180.default.createElement(Text, {
    visuallyHidden: true,
    as: "p",
    key: toastMessage.id
  }, toastMessage.content)) : null);
  return import_react180.default.createElement(TransitionChild, Object.assign({}, props, {
    ...
    "data-polaris-overlay": true,
    ref: containerNode
  }, import_react180.default.createElement(TrapFocus, null, import_react180.default.createElement("div", {
    role: "dialog",
    "aria-modal": true,
    ...
    className: classes
  }, import_react180.default.createElement(KeypressListener, {
    keyCode: Key.Escape,
    keyEvent: "keydown",
...
function FadeUp({
  ...
  return import_react180.default.createElement(CSSTransition_default, Object.assign({}, props, {
...
function CloseButton({
  ...
  const i18n = useI18n();
  return import_react181.default.createElement(Button, {
    variant: "tertiary",
    pressed,
    icon: SvgXIcon,
    onClick,
...
function Header3({
  ...
  if (titleHidden || !children) {
    return import_react182.default.createElement(Box, {
      position: "absolute",
      insetInlineEnd: headerPaddingInline,
      insetBlockStart: headerPaddingBlock,
      zIndex: "1"
    }, import_react182.default.createElement(CloseButton, {
      onClick: onClose
    }));
  }
  return import_react182.default.createElement(Box, {
    ...
    borderColor: "border",
    background: "bg-surface-tertiary"
  }, import_react182.default.createElement(InlineGrid, {
    columns: {
      xs: "1fr auto"
    },
    gap: "400"
  }, import_react182.default.createElement(InlineStack, {
    gap: "400",
    blockAlign: "center"
  }, import_react182.default.createElement(Text, {
    id,
    as: "h2",
    variant: "headingMd",
    breakWord: true
  }, children)), import_react182.default.createElement(CloseButton, {
    pressed: closing,
    onClick: onClose
  })));
}
...
function Footer({
  ...
  const actions = primaryActionButton || secondaryActionButtons ? import_react183.default.createElement(InlineStack, {
    gap: "200"
  }, secondaryActionButtons, primaryActionButton) : null;
  return import_react183.default.createElement(InlineStack, {
    gap: "400",
    blockAlign: "center"
  }, import_react183.default.createElement(Box, {
    borderColor: "border",
    borderBlockStartWidth: "025",
    padding: "400",
    width: "100%"
  }, import_react183.default.createElement(InlineStack, {
    gap: "400",
    blockAlign: "center",
    align: "space-between"
  }, import_react183.default.createElement(Box, null, children), actions)));
}
...
var Modal = function Modal2({
  ...
  const [iframeHeight, setIframeHeight] = (0, import_react184.useState)(IFRAME_LOADING_HEIGHT);
  const [closing, setClosing] = (0, import_react184.useState)(false);
  const headerId = (0, import_react184.useId)();
  const activatorRef = (0, import_react184.useRef)(null);
  const i18n = useI18n();
  const iframeTitle = i18n.translate("Polaris.Modal.iFrameTitle");
  let dialog;
  let backdrop;
  const handleEntered = (0, import_react184.useCallback)(() => {
    if (onTransitionEnd) {
      onTransitionEnd();
    }
  }, [onTransitionEnd]);
  const handleExited = (0, import_react184.useCallback)(() => {
  ...
  const handleIFrameLoad = (0, import_react184.useCallback)((evt) => {
  ...
  if (open) {
    const footerMarkup = !footer && !primaryAction && !secondaryActions ? null : import_react184.default.createElement(Footer, {
      primaryAction,
      secondaryActions
    }, footer);
    const content = sectioned ? wrapWithComponent(children, Section5, {
      titleHidden
    }) : children;
    const body = loading ? import_react184.default.createElement(Box, {
      padding: "400"
    }, import_react184.default.createElement(InlineStack, {
      gap: "400",
      align: "center",
      blockAlign: "center"
    }, import_react184.default.createElement(Spinner, null))) : content;
    const scrollContainerMarkup = noScroll ? import_react184.default.createElement("div", {
      className: styles75.NoScrollBody
    }, import_react184.default.createElement(Box, {
      width: "100%",
      overflowX: "hidden",
      overflowY: "hidden"
    }, body)) : import_react184.default.createElement(Scrollable, {
      shadow: true,
      className: styles75.Body,
      onScrolledToBottom
    }, body);
    const bodyMarkup = src ? import_react184.default.createElement("iframe", {
      name: iFrameName,
      title: iframeTitle,
      src,
    ...
    dialog = import_react184.default.createElement(Dialog, {
      instant,
      labelledBy: headerId,
      onClose,
      ...
      limitHeight,
      setClosing
    }, import_react184.default.createElement(Header3, {
      titleHidden,
      id: headerId,
      closing,
      onClose
    }, title), bodyMarkup, footerMarkup);
    backdrop = import_react184.default.createElement(Backdrop, {
      setClosing,
      onClick: onClose
    });
  }
  const animated = !instant;
  const activatorMarkup = activator && !isRef2(activator) ? import_react184.default.createElement(Box, {
    ref: activatorRef,
    as: activatorWrapper
  }, activator) : null;
  return import_react184.default.createElement(WithinContentContext.Provider, {
    value: true
  }, activatorMarkup, import_react184.default.createElement(Portal, {
    idPrefix: "modal"
  }, import_react184.default.createElement(TransitionGroup_default, {
    appear: animated,
    enter: animated,
    exit: animated
  }, dialog), backdrop));
...
function DiscardConfirmationModal({
  ...
  const i18n = useI18n();
  return import_react185.default.createElement(Modal, {
...
function ContextualSaveBar3({
  ...
  const handleDiscardAction = (0, import_react186.useCallback)(() => {
  ...
  const discardConfirmationModalMarkup = discardAction && discardAction.onAction && discardAction.discardConfirmationModal && import_react186.default.createElement(DiscardConfirmationModal, {
    open: discardConfirmationModalVisible,
    onCancel: toggleDiscardConfirmationModal,
    onDiscard: handleDiscardAction
  });
  const discardActionMarkup = discardAction && import_react186.default.createElement(Button, {
    variant: "tertiary",
    size: "large",
  ...
  const saveActionMarkup = saveAction && import_react186.default.createElement(Button, {
    variant: "primary",
    tone: "success",
    size: "large",
    url: saveAction.url,
  ...
  const imageMarkup = logo && import_react186.default.createElement(Image, {
    style: {
      width
    },
  ...
  const logoMarkup = alignContentFlush || contextControl ? null : import_react186.default.createElement("div", {
    className: styles74.LogoContainer,
    style: {
      width
    }
  }, imageMarkup);
  const contextControlMarkup = contextControl ? import_react186.default.createElement("div", {
    className: styles74.ContextControl
  }, contextControl) : null;
  const contentsClassName = classNames(styles74.Contents, fullWidth && styles74.fullWidth);
  return import_react186.default.createElement(import_react186.default.Fragment, null, import_react186.default.createElement("div", {
    className: styles74.ContextualSaveBar
  }, contextControlMarkup, logoMarkup, import_react186.default.createElement("div", {
    className: contentsClassName
  }, import_react186.default.createElement("div", {
    className: styles74.MessageContainer
  }, import_react186.default.createElement(Icon, {
    source: SvgAlertTriangleIcon
  }), message && import_react186.default.createElement(Text, {
    as: "h2",
    variant: "headingMd",
    tone: "text-inverse",
    truncate: true
  }, message)), import_react186.default.createElement("div", {
    className: styles74.ActionContainer
  }, import_react186.default.createElement(LegacyStack, {
    spacing: "tight",
    wrap: false
...
function useDeepCompareRef(dependencies, comparator = import_react_fast_compare2.default) {
  const dependencyList = (0, import_react187.useRef)(dependencies);
...
function useDeepEffect(callback, dependencies, customCompare) {
  (0, import_react188.useEffect)(callback, useDeepCompareRef(dependencies, customCompare));
}
...
function useDeepCallback(callback, dependencies, customCompare) {
  return (0, import_react189.useCallback)(callback, useDeepCompareRef(dependencies, customCompare));
}
...
function Toast({
  ...
  const durationRemaining = (0, import_react190.useRef)(defaultDuration);
  const timeoutStart = (0, import_react190.useRef)(null);
  const timer = (0, import_react190.useRef)(null);
  ...
  const dismissMarkup = import_react190.default.createElement("button", {
    type: "button",
  ...
  const actionMarkup = action ? import_react190.default.createElement("div", {
  ...
  if (error) {
    leadingIconMarkup = import_react190.default.createElement("div", {
  ...
  if (!action && onClick) {
    return import_react190.default.createElement("button", {
      "aria-live": "assertive",
      className: classNames(className, styles79.WithActionOnComponent),
      type: "button",
      onClick
    }, import_react190.default.createElement(KeypressListener, {
      keyCode: Key.Escape,
      handler: onDismiss
    }), leadingIconMarkup, import_react190.default.createElement(InlineStack, {
      gap: "400",
      blockAlign: "center"
    }, import_react190.default.createElement(Text, Object.assign({
      as: "span",
      variant: "bodyMd",
      fontWeight: "medium"
    }, tone === "magic" && {
...
var ToastManager = (0, import_react191.memo)(function ToastManager2({
  toastMessages
}) {
  const toastNodes = [];
  const [shouldExpand, setShouldExpand] = (0, import_react191.useState)(false);
  const isFullyExpanded = (0, import_react191.useRef)(false);
  const fullyExpandedTimeout = (0, import_react191.useRef)(null);
  const firstToast = (0, import_react191.useRef)(null);
  ...
  const toastsMarkup = toastMessages.map((toast, index) => {
    ...
    const toastNode = (0, import_react191.createRef)();
    ...
    return import_react191.default.createElement(CSSTransition_default, {
    ...
    }, import_react191.default.createElement(Toast, Object.assign({}, toast, {
      isHovered: shouldExpand
    })))));
  });
  return import_react191.default.createElement(Portal, {
    idPrefix: "toast"
  }, import_react191.default.createElement(EventListener, {
    event: "resize",
...
var FrameInner = class extends import_react192.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      skipFocused: false,
    ...
    this.navigationNode = (0, import_react192.createRef)();
  ...
  render() {
    ...
    const navigationMarkup = navigation ? import_react192.default.createElement(UseTheme, null, (theme) => import_react192.default.createElement(TrapFocus, {
      trapping: mobileNavShowing
    }, import_react192.default.createElement(CSSTransition_default, {
    ...
    }, import_react192.default.createElement("div", Object.assign({
      key: "NavContent"
    }, mobileNavAttributes, {
    ...
    }), navigation, import_react192.default.createElement("button", {
      type: "button",
    ...
    const loadingMarkup = loadingStack > 0 ? import_react192.default.createElement("div", {
      className: styles71.LoadingBar,
      id: APP_FRAME_LOADING_BAR
    }, import_react192.default.createElement(Loading2, null)) : null;
    const topBarMarkup = topBar ? import_react192.default.createElement("div", Object.assign({
      className: styles71.TopBar
    }, layer.props, dataPolarisTopBar.props, {
      id: APP_FRAME_TOP_BAR
    }), topBar) : null;
    const globalRibbonMarkup = globalRibbon ? import_react192.default.createElement("div", {
    ...
    const skipMarkup = import_react192.default.createElement("div", {
      className: skipClassName
    }, import_react192.default.createElement("a", {
      href: `#${skipTarget}`,
    ...
    const getFrameClassName = () => classNames(styles71.Frame, navigation && styles71.hasNav, topBar && styles71.hasTopBar, sidebar && styles71.hasSidebar, this.state.scrollbarAlwaysVisible && styles71.ScrollbarAlwaysVisible);
    const contextualSaveBarMarkup = import_react192.default.createElement(CSSAnimation, {
      in: showContextualSaveBar,
      className: styles71.ContextualSaveBar,
      type: "fade"
    }, import_react192.default.createElement(ContextualSaveBar3, this.contextualSaveBar));
    const navigationOverlayMarkup = showMobileNavigation && isNavigationCollapsed ? import_react192.default.createElement(Backdrop, {
    ...
    return import_react192.default.createElement(FrameContext.Provider, {
      value: context
    }, import_react192.default.createElement("div", Object.assign({
      className: getFrameClassName()
    }, layer.props, navigationAttributes), skipMarkup, topBarMarkup, navigationMarkup, contextualSaveBarMarkup, loadingMarkup, navigationOverlayMarkup, import_react192.default.createElement("main", {
      className: styles71.Main,
      id: APP_FRAME_MAIN,
      "data-has-global-ribbon": Boolean(globalRibbon)
    }, import_react192.default.createElement("div", {
      className: styles71.Content
    }, children)), import_react192.default.createElement(ToastManager, {
      toastMessages
    }), globalRibbonMarkup, import_react192.default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    })));
  }
...
function Frame(props) {
  ...
  return import_react192.default.createElement(FrameInner, Object.assign({}, props, {
    i18n,
    mediaQuery
  }));
}
...
function FullscreenBar({
  ...
  const i18n = useI18n();
  const backButtonMarkup = import_react193.default.createElement(Text, {
    as: "span",
    variant: "bodyLg"
  ...
  }, import_react193.default.createElement("button", {
...
function Cell2({
  ...
  const className = classNames(styles82.Cell, columnSpan?.xs && styles82[`Cell-${columnSpan.xs}-column-xs`], columnSpan?.sm && styles82[`Cell-${columnSpan.sm}-column-sm`], columnSpan?.md && styles82[`Cell-${columnSpan.md}-column-md`], columnSpan?.lg && styles82[`Cell-${columnSpan.lg}-column-lg`], columnSpan?.xl && styles82[`Cell-${columnSpan.xl}-column-xl`]);
  const style = {
    gridArea,
...
var IndexFiltersMode = (function(IndexFiltersMode2) {
...
function useIsSticky(mode, disabled, isFlushWhenSticky) {
  ...
  const [indexFilteringHeight, setIndexFiltersHeight] = (0, import_react196.useState)(0);
  const [isSticky, setIsSticky] = (0, import_react196.useState)(false);
  const measurerRef = (0, import_react196.useRef)(null);
  const intersectionRef = (0, import_react196.useRef)(null);
  const handleIntersect = (entries) => {
    entries.forEach((entry) => {
      setIsSticky(!entry.isIntersecting);
    });
  };
  const observerRef = (0, import_react196.useRef)(hasIOSupport ? new IntersectionObserver(handleIntersect, options) : null);
...
function useIsTouchDevice() {
  const [isTouchDevice, setIsTouchDevice] = (0, import_react197.useState)(false);
  const handleTouchStart = (0, import_react197.useCallback)(() => setIsTouchDevice(true), []);
...
function UpdateButtons({
  ...
  const i18n = useI18n();
  const [savedViewName, setSavedViewName] = (0, import_react198.useState)("");
  const [savedViewModalOpen, setSavedViewModalOpen] = (0, import_react198.useState)(false);
  const container = (0, import_react198.useRef)(null);
  ...
  const buttonText = (0, import_react198.useMemo)(() => {
  ...
  const saveButton = import_react198.default.createElement(Button, {
    size: "micro",
  ...
  const cancelButtonMarkup = cancelAction ? import_react198.default.createElement(Button, {
    variant: "tertiary",
    size: "micro",
  ...
  return import_react198.default.createElement(InlineStack, {
    align: "start",
    blockAlign: "center",
    gap: "100"
  }, cancelButtonMarkup, primaryAction.type === "save-as" ? import_react198.default.createElement(Modal, {
    activator: import_react198.default.createElement(InlineStack, null, saveButton),
  ...
  }, import_react198.default.createElement(Modal.Section, null, import_react198.default.createElement(Form, {
    onSubmit: handlePrimaryAction
  }, import_react198.default.createElement(FormLayout, null, import_react198.default.createElement("div", {
    ref: container
  }, import_react198.default.createElement(TextField, {
...
// node_modules/@shopify/polaris/build/esm/components/IndexFilters/components/SortButton/SortButton.js
var SortButtonDirection = (function(SortButtonDirection2) {
...
function SortButton({
  ...
  const i18n = useI18n();
  const [active, setActive] = (0, import_react200.useState)(false);
  ...
  const choiceListChoices = (0, import_react200.useMemo)(() => {
  ...
  const sortButton = import_react200.default.createElement(Tooltip, {
  ...
  return import_react200.default.createElement(Popover2, {
    fluidContent: true,
    ...
    preferredAlignment: "right",
    zIndexOverride: disclosureZIndexOverride
  }, import_react200.default.createElement(Box, {
    minWidth: "148px",
    paddingInlineStart: "300",
    paddingInlineEnd: "300",
    paddingBlockStart: "200",
    ...
    borderBlockEndWidth: "025",
    borderColor: "border-secondary"
  }, import_react200.default.createElement(ChoiceList, {
    ...
    paddingBlockStart: "200",
    paddingBlockEnd: "200"
  }, import_react200.default.createElement(DirectionButton, {
    direction: "asc",
    active: selectedDirection === SortButtonDirection.Asc,
    onClick: handleChangeDirection,
    value: selectedChoices?.[0]?.value
  }, selectedChoices?.[0]?.directionLabel), import_react200.default.createElement(DirectionButton, {
    direction: "desc",
...
function usePrevious(value) {
  const ref = (0, import_react202.useRef)();
...
function DuplicateModal({
  ...
  const i18n = useI18n();
  const [value, setValue] = (0, import_react203.useState)(name);
  const container = (0, import_react203.useRef)(null);
  ...
  const handleChange = (0, import_react203.useCallback)((newValue) => {
    setValue(newValue);
  }, []);
  async function handlePrimaryAction() {
  ...
  return import_react203.default.createElement(Modal, {
    open,
    onClose,
    ...
    instant: true
  }, import_react203.default.createElement(Modal.Section, null, import_react203.default.createElement(Form, {
    onSubmit: handlePrimaryAction
  }, import_react203.default.createElement(FormLayout, null, import_react203.default.createElement("div", {
    ref: container
  }, import_react203.default.createElement(TextField, {
...
function RenameModal({
  ...
  const i18n = useI18n();
  const [value, setValue] = (0, import_react204.useState)(name);
  const container = (0, import_react204.useRef)(null);
  ...
  const handleChange = (0, import_react204.useCallback)((newValue) => {
    setValue(newValue);
  }, []);
  async function handlePrimaryAction() {
    if (isPrimaryActionDisabled) {
  ...
  return import_react204.default.createElement(Modal, {
    open,
    onClose,
    ...
    instant: true
  }, import_react204.default.createElement(Modal.Section, null, import_react204.default.createElement(Form, {
    onSubmit: handlePrimaryAction
  }, import_react204.default.createElement(FormLayout, null, import_react204.default.createElement("div", {
    ref: container
  }, import_react204.default.createElement(TextField, {
...
// node_modules/@shopify/polaris/build/esm/components/Tabs/components/Tab/Tab.js
var Tab = (0, import_react205.forwardRef)(({
  content,
  accessibilityLabel,
  badge,
  id,
  ...
  const [activeModalType, setActiveModalType] = (0, import_react205.useState)(null);
  const wasSelected = (0, import_react205.useRef)(selected);
  const panelFocused = (0, import_react205.useRef)(false);
  ...
  const togglePopoverActive = (0, import_react205.useCallback)(() => {
    if (!actions?.length) {
      return;
    }
    setPopoverActive((popoverActive2) => !popoverActive2);
  }, [actions]);
  const handleClick = (0, import_react205.useCallback)(() => {
    if (disabled) {
      return;
    }
    if (selected) {
  ...
  const handleSaveRenameModal = (0, import_react205.useCallback)(async (value) => {
  ...
  const handleConfirmDeleteView = (0, import_react205.useCallback)(async () => {
    await deleteAction?.onPrimaryAction?.(content);
    handleModalClose();
  }, [deleteAction, content]);
  const handleSaveDuplicateModal = (0, import_react205.useCallback)(async (duplicateName) => {
  ...
  const handleKeyDown5 = (0, import_react205.useCallback)((event) => {
    if (event.key === " ") {
      event.preventDefault();
      handleClick();
    }
  ...
  const tabClassName = classNames(styles86.Tab, icon && styles86["Tab-iconOnly"], popoverActive && styles86["Tab-popoverActive"], selected && styles86["Tab-active"], selected && actions?.length && styles86["Tab-hasActions"]);
  const badgeMarkup = badge ? import_react205.default.createElement(Badge, {
    tone: selected ? void 0 : "new"
  }, badge) : null;
  const disclosureMarkup = selected && actions?.length ? import_react205.default.createElement("div", {
    className: classNames(styles86.IconWrap)
  }, import_react205.default.createElement(Icon, {
    source: SvgChevronDownIcon
  })) : null;
  const activator = import_react205.default.createElement(BaseComponent, {
    id,
    ...
    onClick: handleClick,
    onKeyDown: handleKeyDown5
  }, import_react205.default.createElement(InlineStack, {
    gap: "200",
    align: "center",
    blockAlign: "center",
    wrap: false
  ...
  const renameModal = renameAction ? import_react205.default.createElement(RenameModal, {
    name: content,
  ...
  const duplicateModal = duplicateAction ? import_react205.default.createElement(DuplicateModal, {
  ...
  const deleteModal = deleteAction ? import_react205.default.createElement(Modal, {
    ...
    instant: true
  }, import_react205.default.createElement(Modal.Section, null, i18n.translate("Polaris.Tabs.Tab.deleteModal.description", {
    viewName: content
  }))) : null;
  const markup = isPlainButton || disabled ? activator : import_react205.default.createElement(import_react205.default.Fragment, null, import_react205.default.createElement(Popover2, {
    active: popoverActive,
    activator,
    autofocusTarget: "first-node",
    onClose: togglePopoverActive,
  ...
  }, import_react205.default.createElement(ActionList, {
    actionRole: "menuitem",
  ...
  return import_react205.default.createElement("li", {
...
var Item6 = (0, import_react207.memo)(function Item7({
  id,
  focused,
  children,
  url,
  ...
  const focusedNode = (0, import_react207.useRef)(null);
  ...
  const markup = url ? import_react207.default.createElement(UnstyledLink, Object.assign({}, sharedProps, {
    url
  }), children) : import_react207.default.createElement("button", Object.assign({}, sharedProps, {
    ref: focusedNode,
    type: "button"
  }), children);
  return import_react207.default.createElement("li", null, markup);
});
function noop10() {
}
...
function List({
  ...
  const tabs = disclosureTabs.map(({
    ...
    return import_react208.default.createElement(Item6, Object.assign({
      key: id
    }, tabProps, {
      id,
  ...
  return import_react208.default.createElement("ul", {
...
function CreateViewModal({
  ...
  const i18n = useI18n();
  const [value, setValue] = (0, import_react209.useState)("");
  const [loading, setLoading] = (0, import_react209.useState)(false);
  const container = (0, import_react209.useRef)(null);
  const isTouchDevice = useIsTouchDevice();
  const hasSameNameError = viewNames.some((viewName) => viewName.trim().toLowerCase() === value.trim().toLowerCase());
  ...
  const handleChange = (0, import_react209.useCallback)((newValue) => {
    setValue(newValue);
  }, []);
  async function handlePrimaryAction() {
  ...
  return import_react209.default.createElement(Modal, {
    activator,
    open,
    onClose,
  ...
  }, import_react209.default.createElement(Modal.Section, null, import_react209.default.createElement(Form, {
    onSubmit: handlePrimaryAction
  }, import_react209.default.createElement(FormLayout, null, import_react209.default.createElement("div", {
    ref: container
  }, import_react209.default.createElement(TextField, {
...
var TabMeasurer = (0, import_react210.memo)(function TabMeasurer2({
  ...
  const tabsMarkup = tabs.map((tab, index) => {
    return import_react210.default.createElement(Tab, {
      ...
      url: tab.url,
      content: tab.content,
      onTogglePopover: noop12,
      onToggleModal: noop12
    });
  });
...
var Tabs = ({
  ...
  const scrollRef = (0, import_react211.useRef)(null);
  const wrapRef = (0, import_react211.useRef)(null);
  const selectedTabRef = (0, import_react211.useRef)(null);
  const [state, setState] = (0, import_react211.useReducer)((data, partialData) => {
    return {
      ...data,
      ...partialData
    };
  ...
  const handleTogglePopover = (0, import_react211.useCallback)((isOpen) => setState({
    isTabPopoverOpen: isOpen
  }), []);
  const handleToggleModal = (0, import_react211.useCallback)((isOpen) => setState({
  ...
  const handleTabClick = (0, import_react211.useCallback)((id) => {
  ...
  const renderTabMarkup = (0, import_react211.useCallback)((tab, index) => {
    const handleClick = () => {
    ...
    return import_react211.default.createElement(Tab, Object.assign({}, tab, {
      key: `${index}-${tab.id}`,
      id: tab.id,
  ...
  const handleFocus = (0, import_react211.useCallback)((event) => {
    const target = event.target;
  ...
  const handleBlur = (0, import_react211.useCallback)((event) => {
    const target = event.target;
    const relatedTarget = event.relatedTarget;
    const isInNaturalDOMOrder = relatedTarget?.closest?.(`.${styles86.Tabs}`);
    const targetIsATab = target?.classList?.contains?.(styles86.Tab);
    const focusReceiverIsAnItem = relatedTarget?.classList.contains(styles86.Item);
  ...
  const moveToSelectedTab = (0, import_react211.useCallback)(() => {
    const activeButton = selectedTabRef.current?.querySelector(`.${styles86["Tab-active"]}`);
    if (activeButton) {
  ...
  const handleMeasurement = (0, import_react211.useCallback)((measurements) => {
    const {
  ...
  const disclosureButtonContent = import_react211.default.createElement(import_react211.default.Fragment, null, import_react211.default.createElement(Text, {
    as: "span",
    variant: "bodySm",
    fontWeight: "medium"
  }, disclosureText ?? i18n.translate("Polaris.Tabs.toggleTabsLabel")), import_react211.default.createElement("div", {
    className: classNames(styles86.IconWrap, disclosureActivatorVisible && showDisclosure && styles86["IconWrap-open"])
  }, import_react211.default.createElement(Icon, {
    source: SvgChevronDownIcon,
    tone: "subdued"
  })));
  const disclosureButton = import_react211.default.createElement(UnstyledButton, {
    type: "button",
  ...
  const tabMeasurer = import_react211.default.createElement(TabMeasurer, {
    tabToFocus,
    activator,
    selected,
    tabs,
  ...
  const newTab = import_react211.default.createElement(Tab, {
  ...
  const panelMarkup = children ? tabs.map((_tab, index) => {
    return selected === index ? import_react211.default.createElement(Panel, {
      id: tabs[index].panelID || `${tabs[index].id}-panel`,
      tabID: tabs[index].id,
      key: tabs[index].id
    }, children) : import_react211.default.createElement(Panel, {
      id: tabs[index].panelID || `${tabs[index].id}-panel`,
      tabID: tabs[index].id,
      key: tabs[index].id,
      hidden: true
  ...
  return import_react211.default.createElement("div", {
  ...
  }, tabMeasurer, import_react211.default.createElement("div", {
    className: wrapperClassNames,
    ref: scrollRef
  }, import_react211.default.createElement("div", {
    className: styles86.ButtonWrapper,
    ref: wrapRef
  }, import_react211.default.createElement("ul", {
  ...
  }, tabsMarkup, mdDown || tabsToShow.length === 0 ? null : import_react211.default.createElement("li", {
    className: disclosureTabClassName,
    role: "presentation"
  }, import_react211.default.createElement(Popover2, {
    preferredPosition: "below",
    preferredAlignment: "left",
    activator,
    ...
    autofocusTarget: "first-node",
    zIndexOverride: disclosureZIndexOverride
  }, import_react211.default.createElement(List, {
    focusIndex: hiddenTabs.indexOf(tabToFocus),
    disclosureTabs,
    onClick: handleListTabClick,
    onKeyPress: handleKeyPress
  })))), canCreateNewView && tabsToShow.length > 0 ? import_react211.default.createElement("div", {
    className: styles86.NewTab
  }, import_react211.default.createElement(CreateViewModal, {
    open: isNewViewModalActive,
    onClose: handleCloseNewViewModal,
    onClickPrimaryAction: handleSaveNewViewModal,
    viewNames,
    activator: disabled ? newTab : import_react211.default.createElement("div", null, import_react211.default.createElement(Tooltip, {
...
function SearchFilterButton({
  ...
  const iconMarkup = import_react212.default.createElement(InlineStack, {
    gap: "0"
  }, hideQueryField ? null : import_react212.default.createElement(Icon, {
    source: SvgSearchIcon,
    tone: "base"
  }), hideFilters ? null : import_react212.default.createElement(Icon, {
    source: SvgFilterIcon,
    tone: "base"
  }));
  const activator = import_react212.default.createElement("div", {
    style
  }, import_react212.default.createElement(Button, {
    size: "slim",
    onClick,
    disabled,
    icon: iconMarkup,
  ...
  const content = import_react212.default.createElement(Text, {
    as: "span",
    variant: "bodyMd",
    alignment: "center"
  }, tooltipContent);
  return import_react212.default.createElement(Tooltip, {
    content,
    preferredPosition: "above",
    hoverDelay: 400,
    zIndexOverride: disclosureZIndexOverride
...
function EditColumnsButton({
  ...
  const i18n = useI18n();
  const tooltipContent = import_react213.default.createElement(Text, {
    as: "span",
    variant: "bodyMd",
    alignment: "center"
  }, i18n.translate("Polaris.IndexFilters.EditColumnsButton.tooltip"));
  return import_react213.default.createElement(Tooltip, {
...
function IndexFilters({
  ...
  const defaultRef = (0, import_react214.useRef)(null);
  const filteringRef = (0, import_react214.useRef)(null);
  const {
  ...
  const handleChangeSortButton = (0, import_react214.useCallback)((value) => {
    onSort?.(value);
  }, [onSort]);
  const handleChangeSearch = (0, import_react214.useCallback)((value) => {
    onQueryChange(value);
  }, [onQueryChange]);
  const useExecutedCallback = (action, afterEffect) => (0, import_react214.useCallback)(async (name) => {
  ...
  const onExecutedCancelAction = (0, import_react214.useCallback)(() => {
    cancelAction?.onAction?.();
    setMode(IndexFiltersMode.Default);
  }, [cancelAction, setMode]);
  const enhancedPrimaryAction = (0, import_react214.useMemo)(() => {
    return primaryAction ? {
      ...primaryAction,
      onAction: onExecutedPrimaryAction
    } : void 0;
  }, [onExecutedPrimaryAction, primaryAction]);
  const enhancedCancelAction = (0, import_react214.useMemo)(() => {
    return cancelAction ? {
      ...cancelAction,
      onAction: onExecutedCancelAction
    } : void 0;
  }, [cancelAction, onExecutedCancelAction]);
  const beginEdit = (0, import_react214.useCallback)((mode2) => {
    setMode(mode2);
    onEditStart?.(mode2);
  }, [onEditStart, setMode]);
  const updateButtonsMarkup = (0, import_react214.useMemo)(() => enhancedCancelAction || enhancedPrimaryAction ? import_react214.default.createElement(UpdateButtons, {
  ...
  const sortMarkup = (0, import_react214.useMemo)(() => {
    if (!sortOptions?.length) {
      return null;
    }
    return import_react214.default.createElement(SortButton, {
      choices: sortOptions,
  ...
  const editColumnsMarkup = showEditColumnsButton ? import_react214.default.createElement(EditColumnsButton, {
  ...
  return import_react214.default.createElement("div", {
    ...
    ref: measurerRef
  }, import_react214.default.createElement(Transition_default, {
    nodeRef: defaultRef,
    in: mode !== IndexFiltersMode.Filtering,
    timeout: TRANSITION_DURATION2
  }, (state) => import_react214.default.createElement("div", {
    ref: defaultRef
  }, mode !== IndexFiltersMode.Filtering ? import_react214.default.createElement(Container, null, import_react214.default.createElement(InlineStack, {
    align: "start",
    blockAlign: "center",
    gap: {
      xs: "0",
  ...
  }, import_react214.default.createElement(Tabs, {
    tabs,
    selected,
    onSelect,
    ...
    canCreateNewView,
    onCreateNewView
  })), isLoading && mdDown && import_react214.default.createElement("div", {
    className: styles83.TabsLoading
  }, import_react214.default.createElement(Spinner, {
    size: "small"
  }))), import_react214.default.createElement("div", {
    className: styles83.ActionWrap
  }, isLoading && !mdDown && import_react214.default.createElement("div", {
    className: styles83.DesktopLoading
  }, isLoading ? import_react214.default.createElement(Spinner, {
    size: "small"
  }) : null), mode === IndexFiltersMode.Default ? import_react214.default.createElement(import_react214.default.Fragment, null, hideFilters && hideQueryField ? null : import_react214.default.createElement(SearchFilterButton, {
    ...
    disclosureZIndexOverride
  }), editColumnsMarkup, sortMarkup) : null, mode === IndexFiltersMode.EditingColumns ? updateButtonsMarkup : null))) : null)), import_react214.default.createElement(Transition_default, {
    nodeRef: filteringRef,
    in: mode === IndexFiltersMode.Filtering,
    timeout: TRANSITION_DURATION2
  }, (state) => import_react214.default.createElement("div", {
    ref: filteringRef
  }, mode === IndexFiltersMode.Filtering ? import_react214.default.createElement(Filters, {
    queryValue,
    queryPlaceholder,
  ...
  }, import_react214.default.createElement(InlineStack, {
    gap: "200",
    align: "start",
    blockAlign: "center"
  }, import_react214.default.createElement("div", {
...
function useSetIndexFiltersMode(defaultMode = IndexFiltersMode.Default) {
  const [mode, setMode] = (0, import_react215.useState)(defaultMode);
  return {
    mode,
    setMode
  };
...
var SelectionType2 = (function(SelectionType3) {
  SelectionType3["All"] = "all";
  SelectionType3["Page"] = "page";
  SelectionType3["Multi"] = "multi";
  SelectionType3["Single"] = "single";
...
var IndexContext = (0, import_react216.createContext)(void 0);
var IndexSelectionChangeContext = (0, import_react216.createContext)(void 0);
var IndexRowContext = (0, import_react216.createContext)(void 0);

// node_modules/@shopify/polaris/build/esm/utilities/index-provider/hooks.js
function useIndexSelectionChange() {
  const onSelectionChange = (0, import_react217.useContext)(IndexSelectionChangeContext);
...
function useIndexRow() {
  const indexRow = (0, import_react217.useContext)(IndexRowContext);
  if (!indexRow) {
    throw new Error(`Missing IndexProvider context`);
  }
  return indexRow;
...
function useIndexValue() {
  const index = (0, import_react217.useContext)(IndexContext);
  if (!index) {
    throw new Error(`Missing IndexProvider context`);
  }
  return index;
...
function useHandleBulkSelection({
  ...
  const lastSelected = (0, import_react217.useRef)(null);
  const handleSelectionChange = (0, import_react217.useCallback)((selectionType, toggleType, selection, sortOrder) => {
...
function IndexProvider({
  ...
  const contextValue = (0, import_react218.useMemo)(() => ({
    itemCount,
  ...
  const rowContextValue = (0, import_react218.useMemo)(() => ({
    selectable: isSelectableIndex,
    selectMode: selectMode && isSelectableIndex,
    condensed
  }), [condensed, selectMode, isSelectableIndex]);
  return import_react218.default.createElement(IndexContext.Provider, {
    value: contextValue
  }, import_react218.default.createElement(IndexRowContext.Provider, {
    value: rowContextValue
  }, import_react218.default.createElement(IndexSelectionChangeContext.Provider, {
...
var RowContext = (0, import_react219.createContext)({});
var RowHoveredContext = (0, import_react219.createContext)(void 0);
var scrollDefaultContext = {
  scrollableContainer: null,
  canScrollLeft: false,
  canScrollRight: false
};
var ScrollContext = (0, import_react219.createContext)(scrollDefaultContext);
...
var Cell3 = (0, import_react220.memo)(function Cell4({
  children,
  ...
  return import_react220.default.createElement(as, {
    id,
    colSpan,
    headers,
    scope,
...
// node_modules/@shopify/polaris/build/esm/components/IndexTable/components/Checkbox/Checkbox.js
var Checkbox3 = (0, import_react221.memo)(function Checkbox4({
  accessibilityLabel
}) {
  const i18n = useI18n();
  const {
  ...
  const {
    ...
    disabled,
    onInteraction
  } = (0, import_react221.useContext)(RowContext);
  const label = accessibilityLabel ? accessibilityLabel : i18n.translate("Polaris.IndexTable.selectItem", {
    resourceName: resourceName.singular
  });
  return import_react221.default.createElement(CheckboxWrapper, null, import_react221.default.createElement("div", {
    className: styles88.Wrapper,
    onClick: onInteraction,
    onKeyUp: noop13
  }, import_react221.default.createElement(Checkbox, {
    id: `Select-${itemId}`,
    label,
    labelHidden: true,
    checked: selected,
...
function CheckboxWrapper({
  ...
  const checkboxNode = (0, import_react221.useRef)(null);
  const handleResize = (0, import_react221.useCallback)(debounce(() => {
  ...
  return import_react221.default.createElement("td", {
...
// node_modules/@shopify/polaris/build/esm/components/IndexTable/components/Row/Row.js
var Row = (0, import_react222.memo)(function Row2({
  children,
  hideSelectable,
  selected,
  id,
  ...
  const handleInteraction = (0, import_react222.useCallback)((event) => {
    event.stopPropagation();
  ...
  const contextValue = (0, import_react222.useMemo)(() => ({
    itemId: id,
    selected,
    position,
  ...
  const primaryLinkElement = (0, import_react222.useRef)(null);
  const isNavigating = (0, import_react222.useRef)(false);
  const tableRowRef = (0, import_react222.useRef)(null);
  const tableRowCallbackRef = (0, import_react222.useCallback)((node) => {
  ...
  const rowClassName = classNames(styles87.TableRow, rowType === "subheader" && styles87["TableRow-subheader"], rowType === "child" && styles87["TableRow-child"], rowIsSelectable && condensed && styles87.condensedRow, selected && styles87["TableRow-selected"], hovered && !condensed && styles87["TableRow-hovered"], disabled && styles87["TableRow-disabled"], tone && styles87[variationName("tone", tone)], !rowIsSelectable && !onClick && !primaryLinkElement.current && styles87["TableRow-unclickable"]);
  let handleRowClick;
  ...
  const checkboxMarkup = hideSelectable ? import_react222.default.createElement(Cell3, null) : import_react222.default.createElement(Checkbox3, {
    accessibilityLabel
  });
  return import_react222.default.createElement(RowContext.Provider, {
    value: contextValue
  }, import_react222.default.createElement(RowHoveredContext.Provider, {
    value: hovered
  }, import_react222.default.createElement(RowWrapper, {
    key: id,
    id,
...
function ScrollContainer({
  ...
  const [containerScroll, setContainerScroll] = (0, import_react223.useState)(scrollDefaultContext);
  const handleScroll = (0, import_react223.useCallback)(debounce(() => {
  ...
  return import_react223.default.createElement(ScrollContext.Provider, {
...
function IndexTableBase({
  ...
  const tablePosition = (0, import_react224.useRef)({
    top: 0,
    left: 0
  });
  const tableHeadingRects = (0, import_react224.useRef)([]);
  const scrollableContainerElement = (0, import_react224.useRef)(null);
  const tableElement = (0, import_react224.useRef)(null);
  const tableBodyElement = (0, import_react224.useRef)(null);
  const condensedListElement = (0, import_react224.useRef)(null);
  const [tableInitialized, setTableInitialized] = (0, import_react224.useState)(false);
  const [stickyWrapper, setStickyWrapper] = (0, import_react224.useState)(null);
  const [hideScrollContainer, setHideScrollContainer] = (0, import_react224.useState)(true);
  const tableHeadings = (0, import_react224.useRef)([]);
  const stickyTableHeadings = (0, import_react224.useRef)([]);
  const stickyHeaderWrapperElement = (0, import_react224.useRef)(null);
  const firstStickyHeaderElement = (0, import_react224.useRef)(null);
  const stickyHeaderElement = (0, import_react224.useRef)(null);
  const scrollBarElement = (0, import_react224.useRef)(null);
  const scrollContainerElement = (0, import_react224.useRef)(null);
  const scrollingWithBar = (0, import_react224.useRef)(false);
  const scrollingContainer = (0, import_react224.useRef)(false);
  const lastSortedColumnIndex = (0, import_react224.useRef)(sortColumnIndex);
  const renderAfterSelectEvent = (0, import_react224.useRef)(false);
  const lastSelectedItemsCount = (0, import_react224.useRef)(0);
  const hasSelected = (0, import_react224.useRef)(false);
  ...
  const tableBodyRef = (0, import_react224.useCallback)((node) => {
    if (node !== null && !tableInitialized) {
      setTableInitialized(true);
    }
    tableBodyElement.current = node;
  }, [tableInitialized]);
  const handleSelectAllItemsInStore = (0, import_react224.useCallback)(() => {
  ...
  const resizeTableHeadings = (0, import_react224.useMemo)(() => debounce(() => {
  ...
  const resizeTableScrollBar = (0, import_react224.useCallback)(() => {
  ...
  const debounceResizeTableScrollbar = (0, import_react224.useCallback)(debounce(resizeTableScrollBar, SCROLL_BAR_DEBOUNCE_PERIOD, {
    trailing: true
  }), [resizeTableScrollBar]);
  const [canScrollRight, setCanScrollRight] = (0, import_react224.useState)(true);
  const handleCanScrollRight = (0, import_react224.useCallback)(debounce(() => {
  ...
  const [canFitStickyColumn, setCanFitStickyColumn] = (0, import_react224.useState)(true);
  const handleCanFitStickyColumn = (0, import_react224.useCallback)(() => {
  ...
  const handleResize = (0, import_react224.useCallback)(() => {
  ...
  const handleScrollContainerScroll = (0, import_react224.useCallback)((canScrollLeft, canScrollRight2) => {
  ...
  const handleScrollBarScroll = (0, import_react224.useCallback)(() => {
    if (!scrollableContainerElement.current || !scrollBarElement.current) {
      return;
    }
  ...
  const [selectedItemsCountValue, setSelectedItemsCountValue] = (0, import_react224.useState)(selectedItemsCount === SELECT_ALL_ITEMS ? `${itemCount}+` : selectedItemsCount);
  (0, import_react224.useEffect)(() => {
  ...
  const handleTogglePage = (0, import_react224.useCallback)(() => {
  ...
  const loadingMarkup = import_react224.default.createElement("div", {
    className: classNames(styles87.LoadingPanel, loading && styles87.LoadingPanelEntered)
  }, import_react224.default.createElement("div", {
    className: styles87.LoadingPanelRow
  }, import_react224.default.createElement(Spinner, {
    size: "small"
  }), import_react224.default.createElement("span", {
  ...
  const stickyHeaderMarkup = import_react224.default.createElement("div", {
    className: stickyTableClassNames,
    role: "presentation"
  }, import_react224.default.createElement(Sticky, {
    ...
    const bulkActionsMarkup = shouldShowActions && !condensed ? import_react224.default.createElement("div", {
      className: bulkActionsClassName
    }, import_react224.default.createElement(BulkActions, {
      selectMode,
    ...
    const headerMarkup = condensed ? import_react224.default.createElement("div", {
      className: classNames(styles87.HeaderWrapper, (!selectable || condensed) && styles87.unselectable)
    }, loadingMarkup, sort) : import_react224.default.createElement("div", {
      className: stickyHeaderClassNames,
      ref: stickyHeaderWrapperElement
    }, loadingMarkup, import_react224.default.createElement("div", {
      className: styles87.StickyTableHeadings,
      ref: stickyHeaderElement
    }, stickyHeadingsMarkup));
    return import_react224.default.createElement(import_react224.default.Fragment, null, headerMarkup, bulkActionsMarkup);
  }));
  ...
  const scrollBarMarkup = itemCount > 0 ? import_react224.default.createElement(AfterInitialMount, {
  ...
  const emptyStateMarkup = emptyState ? emptyState : import_react224.default.createElement(EmptySearchResult, {
  ...
  const sharedMarkup = import_react224.default.createElement(import_react224.default.Fragment, null, import_react224.default.createElement(EventListener, {
    event: "resize",
    handler: handleResize
  }), stickyHeaderMarkup);
  const condensedClassNames = classNames(styles87.CondensedList, hasZebraStriping && styles87.ZebraStriping);
  const bodyMarkup = condensed ? import_react224.default.createElement(import_react224.default.Fragment, null, sharedMarkup, import_react224.default.createElement("ul", {
    "data-selectmode": Boolean(selectMode),
    className: condensedClassNames,
    ref: condensedListElement
  }, children)) : import_react224.default.createElement(import_react224.default.Fragment, null, sharedMarkup, import_react224.default.createElement(ScrollContainer, {
    scrollableContainerRef: scrollableContainerElement,
    onScroll: handleScrollContainerScroll
  }, import_react224.default.createElement("table", {
    ref: tableElement,
    className: tableClassNames
  }, import_react224.default.createElement("thead", null, import_react224.default.createElement("tr", {
    className: styles87.HeadingRow
  }, headingsMarkup)), import_react224.default.createElement("tbody", {
    ref: tableBodyRef
  }, children))));
  const tableContentMarkup = itemCount > 0 ? bodyMarkup : import_react224.default.createElement("div", {
    className: styles87.EmptySearchResultWrapper
  }, emptyStateMarkup);
  const paginationMarkup = pagination ? import_react224.default.createElement("div", {
    className: styles87.PaginationWrapper
  }, import_react224.default.createElement(Pagination, Object.assign({
    type: "table"
  }, pagination))) : null;
  return import_react224.default.createElement(import_react224.default.Fragment, null, import_react224.default.createElement("div", {
  ...
  function renderHeading(heading, index, Tag2, tagProps, id) {
    ...
    const headingContent = import_react224.default.createElement(Tag2, Object.assign({
      id,
    ...
    const checkboxContent = import_react224.default.createElement(Tag2, Object.assign({
      className: checkboxClassName,
      key: `${heading}-${index}`
  ...
  function renderCheckboxContent() {
    ...
    }, import_react224.default.createElement(Checkbox, {
  ...
  function renderHeadingContent(heading, index) {
    ...
    const headingTitle = import_react224.default.createElement(Text, {
      as: "span",
      variant: "bodySm",
      fontWeight: "medium",
    ...
    if (heading.new) {
      headingContent = import_react224.default.createElement(LegacyStack, {
        wrap: false,
        alignment: "center"
      }, headingTitle, import_react224.default.createElement(Badge, {
        tone: "new"
    ...
    if (sortable?.[index]) {
      ...
      const iconMarkup = import_react224.default.createElement("span", {
      ...
      }, import_react224.default.createElement(SourceComponent, {
        focusable: "false",
        "aria-hidden": "true",
      ...
      const sortMarkup = import_react224.default.createElement(UnstyledButton, defaultSortButtonProps, iconMarkup, import_react224.default.createElement("span", {
      ...
      if (!heading.tooltipContent) {
        return (
          ...
          }, import_react224.default.createElement(Tooltip, Object.assign({}, defaultTooltipProps, {
      ...
      if (heading.tooltipContent) {
        return (
          ...
          import_react224.default.createElement("div", {
            ...
            style
          }, import_react224.default.createElement(UnstyledButton, defaultSortButtonProps, import_react224.default.createElement(Tooltip, defaultHeaderTooltipProps, import_react224.default.createElement("span", {
            className: styles87.TableHeadingUnderline
          }, headingContent)), import_react224.default.createElement(Tooltip, Object.assign({}, defaultTooltipProps, {
            content: sortTooltipContent,
            preferredPosition: "above"
          }), iconMarkup)))
        );
    ...
    if (heading.tooltipContent) {
      return (
        ...
        import_react224.default.createElement("div", {
          style,
          className: classNames(heading.paddingBlockEnd && styles87["TableHeading-extra-padding-right"])
        }, import_react224.default.createElement(Tooltip, Object.assign({}, defaultHeaderTooltipProps, {
          activatorWrapper: "span"
        }), import_react224.default.createElement("span", {
...
function IndexTable({
  ...
  return import_react224.default.createElement(import_react224.default.Fragment, null, import_react224.default.createElement(IndexProvider, {
    ...
    onSelectionChange,
    paginatedSelectAllText
  }, import_react224.default.createElement(IndexTableBase, indexTableBaseProps, children)));
}
...
var InlineCode = ({
  children
}) => import_react225.default.createElement("code", {
...
function KeyboardKey({
  ...
  const className = classNames(styles91.KeyboardKey, size && styles91[size]);
  return import_react226.default.createElement("kbd", {
    className
  }, key);
}
...
function AnnotatedSection({
  ...
  const descriptionMarkup = typeof description === "string" ? import_react228.default.createElement(Text, {
    as: "p",
    variant: "bodyMd"
  ...
  }, import_react228.default.createElement(TextContainer, {
    spacing: "tight"
  }, import_react228.default.createElement(Text, {
    id,
    variant: "headingMd",
    as: "h2"
  }, title), descriptionMarkup && import_react228.default.createElement(Box, {
    color: "text-secondary"
  }, descriptionMarkup))), import_react228.default.createElement("div", {
...
var Layout = function Layout2({
  ...
  const content = sectioned ? import_react230.default.createElement(Section6, null, children) : children;
...
var ResourceListContext = (0, import_react231.createContext)({});
...
var ConnectedFilterControl = class extends import_react233.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      availableWidth: 0,
    ...
    this.container = (0, import_react233.createRef)();
    this.proxyButtonContainer = (0, import_react233.createRef)();
    this.moreFiltersButtonContainer = (0, import_react233.createRef)();
    this.handleResize = debounce(() => {
  ...
  render() {
    ...
    const rightMarkup = actionsToRender.length > 0 ? import_react233.default.createElement("div", {
    ...
    const rightActionMarkup = rightAction ? import_react233.default.createElement("div", {
      ref: this.moreFiltersButtonContainer,
      className: moreFiltersButtonContainerClassname
    }, shouldRenderMoreFiltersButton && import_react233.default.createElement(Item8, null, rightAction)) : null;
    const proxyButtonMarkup = rightPopoverableActions ? import_react233.default.createElement("div", {
      className: styles95.ProxyButtonContainer,
      ref: this.proxyButtonContainer,
      "aria-hidden": true
    }, rightPopoverableActions.map((action) => import_react233.default.createElement("div", {
      key: action.key,
      "data-key": action.key
    }, this.activatorButtonFrom(action, {
      proxy: true
    })))) : null;
    const auxMarkup = auxiliary ? import_react233.default.createElement("div", {
      className: styles95.AuxiliaryContainer
    }, auxiliary) : null;
    return import_react233.default.createElement(import_react233.default.Fragment, null, proxyButtonMarkup, import_react233.default.createElement("div", {
      className: styles95.Wrapper
    }, import_react233.default.createElement("div", {
      className,
      ref: this.container
    }, children ? import_react233.default.createElement("div", {
      className: styles95.CenterContainer
    }, import_react233.default.createElement(Item8, null, children)) : null, rightMarkup, rightActionMarkup, import_react233.default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    })), auxMarkup));
  }
  ...
  activatorButtonFrom(action, options) {
    ...
    return import_react233.default.createElement(Button, {
      onClick: action.onAction,
      disclosure: true,
  ...
  popoverFrom(actions) {
    return actions.map((action) => {
      return import_react233.default.createElement(Item8, {
        key: action.key
      }, import_react233.default.createElement(Popover2, {
...
function TagsWrapper({
  ...
  if (hidden) {
    return import_react234.default.createElement(Text, {
      as: "span",
      visuallyHidden: true
    }, children);
  }
  return import_react234.default.createElement(import_react234.default.Fragment, null, children);
}
...
function Tag({
  ...
  const className = classNames(styles96.Tag, disabled && styles96.disabled, onClick && styles96.clickable, onRemove && styles96.removable, url && !disabled && styles96.linkable, segmented && styles96.segmented, size && styles96[variationName("size", size)]);
  let tagTitle = accessibilityLabel;
  if (!tagTitle) {
    tagTitle = typeof children === "string" ? children : void 0;
  }
  const tagText = import_react235.default.createElement(Text, {
    as: "span",
    variant: "bodySm",
    truncate: true
  }, import_react235.default.createElement("span", {
    title: tagTitle,
    className: styles96.Text
  }, children));
  if (onClick) {
    return import_react235.default.createElement("button", {
      type: "button",
      disabled,
      className,
      onClick
  ...
  const removeButton = onRemove ? import_react235.default.createElement("button", {
    type: "button",
    "aria-label": ariaLabel,
    ...
    onMouseUp: handleMouseUpByBlurring,
    disabled
  }, import_react235.default.createElement(Icon, {
    source: SvgXSmallIcon
  })) : null;
  const tagContent = url && !disabled ? import_react235.default.createElement("a", {
    className: classNames(styles96.Link, segmented && styles96.segmented),
    href: url
  }, tagText) : tagText;
  return import_react235.default.createElement("span", {
    className,
    "aria-disabled": disabled
  }, tagContent, size === "large" && import_react235.default.createElement("span", {
...
function Sheet({
  ...
  const container = (0, import_react236.useRef)(null);
  const activatorRef = (0, import_react236.useRef)(null);
  const handleClose = (0, import_react236.useCallback)(() => {
    onClose();
  ...
  const activatorMarkup = activator && !isRef3(activator) ? import_react236.default.createElement("div", {
    ref: activatorRef
  }, activator) : null;
  return import_react236.default.createElement(import_react236.default.Fragment, null, activatorMarkup, import_react236.default.createElement(Portal, {
    idPrefix: "sheet"
  }, import_react236.default.createElement(CSSTransition_default, {
    nodeRef: container,
    ...
    onEntered,
    onExit
  }, import_react236.default.createElement("div", Object.assign({
    className: styles97.Container
  }, layer.props, overlay.props, {
    ref: container
  }), import_react236.default.createElement(TrapFocus, {
    trapping: open
    ...
    "aria-label": accessibilityLabel
  }, children)))), import_react236.default.createElement(KeypressListener, {
    keyCode: Key.Escape,
    handler: handleClose
  }), open && import_react236.default.createElement(Backdrop, {
    transparent: true,
    onClick: handleClose
  })));
}
...
// node_modules/@shopify/polaris/build/esm/components/LegacyFilters/LegacyFilters.js
var Suffix = (function(Suffix2) {
  Suffix2["Filter"] = "Filter";
  Suffix2["Shortcut"] = "Shortcut";
  return Suffix2;
})(Suffix || {});
var LegacyFiltersInner = class extends import_react237.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      open: false,
    ...
    this.moreFiltersDoneButtonContainer = (0, import_react237.createRef)();
    this.focusNode = (0, import_react237.createRef)();
    this.closeFilters = () => {
      this.setState({
        open: false
      }, () => {
  ...
  render() {
    ...
    const backdropMarkup = open ? import_react237.default.createElement(import_react237.default.Fragment, null, import_react237.default.createElement(ScrollLock, null), import_react237.default.createElement("div", {
    ...
    const filtersContentMarkup = filters.map((filter, index) => {
      ...
      const appliedFilterBadgeMarkup = appliedFilterContent ? import_react237.default.createElement("div", {
        className: styles94.AppliedFilterBadgeContainer
      }, import_react237.default.createElement(Badge, {
        tone: "new"
      ...
      }, import_react237.default.createElement("h3", {
        className: styles94.FilterTriggerTitle
      }, import_react237.default.createElement(Text, {
        as: "span",
        tone: this.props.disabled || filter.disabled ? "subdued" : void 0
      }, filter.label)), import_react237.default.createElement("span", {
        className: styles94.FilterTriggerIcon
      }, import_react237.default.createElement(Icon, {
        source: icon,
        tone: "base"
      }))), appliedFilterBadgeMarkup), import_react237.default.createElement(Collapsible, {
        id: collapsibleID,
        open: filterIsOpen,
        onAnimationEnd: this.setReadyForFocus(true)
      }, import_react237.default.createElement("div", {
        className: styles94.FilterNodeContainer
      }, import_react237.default.createElement(Focus, {
    ...
    const rightActionMarkup = filters.length ? import_react237.default.createElement("div", {
      ref: this.moreFiltersButtonContainer
    }, import_react237.default.createElement(Button, {
    ...
    const filtersControlMarkup = import_react237.default.createElement(ConnectedFilterControl, {
    ...
    }, hideQueryField ? null : import_react237.default.createElement(TextField, {
      ...
      labelHidden: true,
      prefix: import_react237.default.createElement("span", {
    ...
    const filtersDesktopHeaderMarkup = import_react237.default.createElement("div", {
      className: filtersContainerHeaderClassname
    }, import_react237.default.createElement(Text, {
      variant: "headingLg",
      as: "h3"
    }, moreFiltersLabel), import_react237.default.createElement(Button, {
      icon: SvgXSmallIcon,
      variant: "plain",
      accessibilityLabel: i18n.translate("Polaris.Filters.cancel"),
      onClick: this.closeFilters
    }));
    const filtersMobileHeaderMarkup = import_react237.default.createElement("div", {
      className: filtersContainerHeaderClassname
    }, import_react237.default.createElement(Button, {
      icon: SvgXSmallIcon,
      variant: "plain",
    ...
    const filtersDesktopFooterMarkup = import_react237.default.createElement("div", {
      className: filtersDesktopFooterClassname
    }, import_react237.default.createElement(Button, {
      onClick: this.handleClearAll,
      disabled: !this.hasAppliedFilters()
    }, i18n.translate("Polaris.Filters.clearAllFilters")), import_react237.default.createElement("div", {
      ref: this.moreFiltersDoneButtonContainer
    }, import_react237.default.createElement(Button, {
      onClick: this.closeFilters,
      variant: "primary"
    }, i18n.translate("Polaris.Filters.done"))));
    const filtersMobileFooterMarkup = import_react237.default.createElement("div", {
      className: styles94.LegacyFiltersMobileContainerFooter
    }, this.hasAppliedFilters() ? import_react237.default.createElement(Button, {
      onClick: onClearAll,
      fullWidth: true
    }, i18n.translate("Polaris.Filters.clearAllFilters")) : import_react237.default.createElement("div", {
      ...
      tone: "subdued",
      as: "span"
    }, import_react237.default.createElement("p", null, i18n.translate("Polaris.Filters.noFiltersApplied")))));
    const shouldHideTagsContainer = !appliedFilters || appliedFilters.length < 1;
    const tagsMarkup = !hideTags ? import_react237.default.createElement(TagsWrapper, {
      hidden: shouldHideTagsContainer
    }, import_react237.default.createElement("div", {
      className: styles94.TagsContainer,
      "aria-live": "polite"
    }, (appliedFilters || []).map((filter) => {
      return import_react237.default.createElement(Tag, {
        key: filter.key,
        onRemove: () => {
    ...
    const filtersContainerMarkup = isNavigationCollapsed ? import_react237.default.createElement(Sheet, {
      accessibilityLabel: moreFiltersLabel,
      open,
      onClose: this.closeFilters,
      onEntered: this.setReadyForFocus(true),
      onExit: this.setReadyForFocus(false)
    }, filtersMobileHeaderMarkup, import_react237.default.createElement(Scrollable, {
      className: filtersMobileContainerContentClassName,
      shadow: true
    }, filtersContentMarkup, filtersMobileFooterMarkup)) : import_react237.default.createElement(Sheet, {
      accessibilityLabel: moreFiltersLabel,
      open,
      onClose: this.closeFilters,
      onEntered: this.setReadyForFocus(true),
    ...
    }, filtersDesktopHeaderMarkup, import_react237.default.createElement(Scrollable, {
      className: filtersDesktopContainerContentClassName,
      shadow: true
    }, filtersContentMarkup), filtersDesktopFooterMarkup));
    const helpTextMarkup = helpText ? import_react237.default.createElement("div", {
      id: "FiltersHelpText",
    ...
    return import_react237.default.createElement(WithinFilterContext.Provider, {
      value: true
    }, import_react237.default.createElement("div", {
      className: styles94.LegacyFilters
    }, filtersControlMarkup, filtersContainerMarkup, tagsMarkup, helpTextMarkup, backdropMarkup, import_react237.default.createElement(KeypressListener, {
      keyCode: Key.Escape,
  ...
  generateFilterMarkup(filter) {
    ...
    const clearButtonMarkup = !filter.hideClearButton && import_react237.default.createElement(Button, {
      variant: "plain",
    ...
    return import_react237.default.createElement("div", {
      ref: this.focusNode
    }, import_react237.default.createElement(LegacyStack, {
      vertical: true,
      spacing: "tight"
...
function LegacyFilters(props) {
  const i18n = useI18n();
  const mediaQuery = useMediaQuery2();
  return import_react237.default.createElement(LegacyFiltersInner, Object.assign({}, props, {
    i18n,
    mediaQuery
  }));
}
...
function Tab2({
  ...
  const wasSelected = (0, import_react239.useRef)(selected);
  const panelFocused = (0, import_react239.useRef)(false);
  const node = (0, import_react239.useRef)(null);
  ...
  const markup = url ? import_react239.default.createElement(UnstyledLink, {
    id,
    url,
    role: "tab",
    tabIndex,
  ...
  }, import_react239.default.createElement(Text, {
    as: "span",
    variant: "bodyMd",
    fontWeight: "semibold"
  }, children))) : import_react239.default.createElement("button", {
    id,
    role: "tab",
    type: "button",
    tabIndex,
  ...
  return import_react239.default.createElement("li", {
    className: tabContainerClassNames,
    ref: node,
    role: "presentation"
  }, markup);
...
// node_modules/@shopify/polaris/build/esm/components/LegacyTabs/components/TabMeasurer/TabMeasurer.js
var TabMeasurer3 = (0, import_react240.memo)(function TabMeasurer4({
  selected,
  tabs,
  activator,
  tabToFocus,
  ...
  const containerNode = (0, import_react240.useRef)(null);
  const animationFrame = (0, import_react240.useRef)(null);
  const handleMeasurement = (0, import_react240.useCallback)(() => {
    if (animationFrame.current) {
      cancelAnimationFrame(animationFrame.current);
    }
    animationFrame.current = requestAnimationFrame(() => {
  ...
  const tabsMarkup = tabs.map((tab, index) => {
    return import_react240.default.createElement(Tab2, {
      measuring: true,
  ...
  return import_react240.default.createElement("div", {
    className: classname,
    ref: containerNode
  }, import_react240.default.createElement(EventListener, {
    event: "resize",
...
var Item9 = class extends import_react241.PureComponent {
  constructor(...args) {
    super(...args);
  ...
  render() {
    ...
    const markup = url ? import_react241.default.createElement(UnstyledLink, Object.assign({}, sharedProps, {
      url
    }), children) : import_react241.default.createElement("button", Object.assign({}, sharedProps, {
      type: "button"
    }), children);
    return import_react241.default.createElement("li", null, markup);
  }
};
...
function List2({
  ...
  const tabs = disclosureTabs.map(({
    ...
    return import_react242.default.createElement(Item9, Object.assign({
      key: id
    }, tabProps, {
      id,
      focused: index === focusIndex,
  ...
  return import_react242.default.createElement("div", {
    ...
    onKeyUp: onKeyPress
  }, import_react242.default.createElement(Box, {
    as: "ul",
    padding: "200"
  }, tabs));
}
...
// node_modules/@shopify/polaris/build/esm/components/LegacyTabs/LegacyTabs.js
var TabsInner = class extends import_react243.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      disclosureWidth: 0,
    ...
    this.renderTabMarkup = (tab, index) => {
      ...
      const tabPanelID = tab.panelID || `${tab.id}-panel`;
      return import_react243.default.createElement(Tab2, {
        key: `${index}-${tab.id}`,
        id: tab.id,
        siblingTabHasFocus: tabToFocus > -1,
        focused: index === tabToFocus,
  ...
  render() {
    ...
    const disclosureTabs = hiddenTabs.map((tabIndex) => tabs[tabIndex]);
    const panelMarkup = children ? tabs.map((_tab, index) => {
      return selected === index ? import_react243.default.createElement(Panel2, {
        id: tabs[index].panelID || `${tabs[index].id}-panel`,
        tabID: tabs[index].id,
        key: tabs[index].id
      }, children) : import_react243.default.createElement(Panel2, {
        id: tabs[index].panelID || `${tabs[index].id}-panel`,
        tabID: tabs[index].id,
        key: tabs[index].id,
        hidden: true
    ...
    const disclosureButtonContent = hasCustomDisclosure ? import_react243.default.createElement(import_react243.default.Fragment, null, disclosureText, import_react243.default.createElement(Icon, {
      source: SvgChevronDownIcon,
      tone: "subdued"
    })) : import_react243.default.createElement(Icon, {
      source: SvgMenuHorizontalIcon,
      tone: "subdued"
    });
    const disclosureButton = import_react243.default.createElement("button", {
      type: "button",
      className: disclosureButtonClassName,
    ...
    const activator = disclosureText ? import_react243.default.createElement("div", {
      className: styles98.TabContainer
    }, disclosureButton) : disclosureButton;
    return import_react243.default.createElement("div", null, import_react243.default.createElement(Box, {
      borderBlockEndWidth: "025",
      borderColor: "border-secondary",
      paddingInlineStart: "200",
      paddingInlineEnd: "200"
    }, import_react243.default.createElement(TabMeasurer3, {
      tabToFocus,
      activator,
      selected,
      tabs,
    ...
    }), import_react243.default.createElement("ul", {
      role: "tablist",
      className: classname,
      onFocus: this.handleFocus,
      onBlur: this.handleBlur,
    ...
    }, tabsMarkup, import_react243.default.createElement("li", {
      className: disclosureTabClassName,
      role: "presentation"
    }, import_react243.default.createElement(Popover2, {
      preferredPosition: "below",
      activator,
      active: disclosureActivatorVisible && showDisclosure,
      onClose: this.handleClose,
      autofocusTarget: "first-node"
    }, import_react243.default.createElement(List2, {
      focusIndex: hiddenTabs.indexOf(tabToFocus),
      disclosureTabs,
      onClick: this.handleTabClick,
...
function LegacyTabs(props) {
  const i18n = useI18n();
  return import_react243.default.createElement(TabsInner, Object.assign({}, props, {
    i18n
  }));
}
...
function Link({
  ...
  return import_react244.default.createElement(BannerContext.Consumer, null, (BannerContext2) => {
    ...
    return url ? import_react244.default.createElement(UnstyledLink, {
      onClick,
      className,
      url,
      external,
      ...
      "aria-label": accessibilityLabel,
      "data-primary-link": dataPrimaryLink
    }, children) : import_react244.default.createElement("button", {
      type: "button",
      onClick,
      className,
      id,
...
function Item10({
  ...
  return import_react245.default.createElement("li", {
...
var List3 = function List4({
  ...
  return import_react246.default.createElement(ListElement, {
    className
  }, children);
};
List3.Item = Item10;
...
var Loading3 = (0, import_react247.memo)(function Loading4() {
  const {
    startLoading,
    stopLoading
  } = useFrame();
...
function MediaCard({
  ...
  if (title) {
    const headerContent = typeof title === "string" ? import_react248.default.createElement(Text, {
      variant: "headingSm",
      as: "h2"
    }, title) : title;
    headerMarkup = import_react248.default.createElement("div", null, headerContent);
  }
  const dismissButtonMarkup = onDismiss ? import_react248.default.createElement(Button, {
    icon: SvgXIcon,
    onClick: onDismiss,
    size: "slim",
  ...
  const popoverActivator = import_react248.default.createElement(InlineStack, {
    blockAlign: "center"
  }, import_react248.default.createElement(Button, {
    icon: SvgMenuHorizontalIcon,
    onClick: togglePopoverActive,
    size: "slim",
  ...
  const popoverActionsMarkup = popoverActions.length > 0 ? import_react248.default.createElement(Popover2, {
    active: popoverActive,
    activator: popoverActivator,
    onClose: togglePopoverActive,
    preferredAlignment: "left",
    preferredPosition: "below"
  }, import_react248.default.createElement(ActionList, {
    items: popoverActions,
    onActionAnyItem: togglePopoverActive
  })) : null;
  const primaryActionMarkup = primaryAction ? import_react248.default.createElement("div", null, buttonFrom(primaryAction)) : null;
  const secondaryActionMarkup = secondaryAction ? import_react248.default.createElement("div", null, buttonFrom(secondaryAction)) : null;
  const actionClassName = classNames(styles101.ActionContainer, portrait && styles101.portrait);
  const actionMarkup = primaryActionMarkup || secondaryActionMarkup ? import_react248.default.createElement("div", {
    className: actionClassName
  }, import_react248.default.createElement(ButtonGroup, null, primaryActionMarkup, secondaryActionMarkup)) : null;
  const mediaCardClassName = classNames(styles101.MediaCard, portrait && styles101.portrait);
  const mediaContainerClassName = classNames(styles101.MediaContainer, portrait && styles101.portrait, size === "small" && styles101.sizeSmall);
  const infoContainerClassName = classNames(styles101.InfoContainer, portrait && styles101.portrait, size === "small" && styles101.sizeSmall);
  const popoverOrDismissMarkup = popoverActionsMarkup || dismissButtonMarkup ? import_react248.default.createElement(Box, {
    position: "absolute",
    insetInlineEnd: "500",
    zIndex: "var(--p-z-index-2)"
  }, import_react248.default.createElement(InlineStack, {
    gap: "100",
    wrap: false
  }, popoverActionsMarkup, dismissButtonMarkup)) : null;
  return import_react248.default.createElement(LegacyCard, null, import_react248.default.createElement("div", {
    className: mediaCardClassName
  }, import_react248.default.createElement("div", {
    className: mediaContainerClassName
  }, children), import_react248.default.createElement("div", {
    className: infoContainerClassName
  }, import_react248.default.createElement(Box, {
    padding: "500"
  }, import_react248.default.createElement(BlockStack, {
    gap: "200"
  }, import_react248.default.createElement(InlineStack, {
    wrap: false,
    align: "space-between",
    gap: "200"
  }, headerMarkup, popoverOrDismissMarkup), import_react248.default.createElement(Text, {
    as: "p",
    variant: "bodySm"
...
var NavigationContext = (0, import_react249.createContext)({
  location: ""
});
...
var MatchState = (function(MatchState2) {
...
function SecondaryNavigation({
  ...
  const uid = (0, import_react250.useId)();
  const {
    onNavigationDismiss
  } = (0, import_react250.useContext)(NavigationContext);
  const [hoveredItem, setHoveredItem] = (0, import_react250.useState)();
  ...
  return import_react250.default.createElement("div", {
  ...
  }, import_react250.default.createElement(Collapsible, {
    ...
    return import_react250.default.createElement(ItemComponent, Object.assign({
      key: label
    }, rest, {
      label,
...
function Item11({
  ...
  const secondaryNavigationId = (0, import_react251.useId)();
  const {
    location,
    onNavigationDismiss
  } = (0, import_react251.useContext)(NavigationContext);
  const navTextRef = (0, import_react251.useRef)(null);
  const [isTruncated, setIsTruncated] = (0, import_react251.useState)(false);
  ...
  const indicatorMarkup = hasNewChild ? import_react251.default.createElement("span", {
    className: styles102.Indicator
  }, import_react251.default.createElement(Indicator, {
    pulse: true
  })) : null;
  ...
  const iconMarkup = icon ? import_react251.default.createElement("div", {
  ...
  if (isNew) {
    badgeMarkup = import_react251.default.createElement(Badge, {
      tone: "new"
  ...
  const wrappedBadgeMarkup = badgeMarkup == null ? null : import_react251.default.createElement("div", {
  ...
  const itemLabelMarkup = import_react251.default.createElement("span", {
    className: classNames(styles102.Text, truncateText && styles102["Text-truncated"]),
    ref: navTextRef
  }, import_react251.default.createElement(Text, {
    as: "span",
    variant: "bodyMd",
    tone,
    fontWeight
  ...
  if (url == null) {
    ...
    return import_react251.default.createElement("li", {
    ...
    }, import_react251.default.createElement("button", {
      type: "button",
  ...
  const secondaryActionMarkup = actions?.length ? import_react251.default.createElement("span", {
    className: styles102.SecondaryActions
  }, actions.map((action) => import_react251.default.createElement(ItemSecondaryAction, Object.assign({
    key: action.accessibilityLabel
  }, action, {
    tabIndex,
    disabled
  })))) : null;
  const itemContentMarkup = import_react251.default.createElement(import_react251.default.Fragment, null, iconMarkup, itemLabelMarkup, secondaryActionMarkup ? null : wrappedBadgeMarkup);
  const outerContentMarkup = import_react251.default.createElement(import_react251.default.Fragment, null, secondaryActionMarkup ? wrappedBadgeMarkup : null);
  ...
  if (subNavigationItems.length > 0) {
    ...
    secondaryNavigationMarkup = import_react251.default.createElement(SecondaryNavigation, {
  ...
  const itemLinkMarkup = () => {
    const linkMarkup = import_react251.default.createElement(UnstyledLink, Object.assign({
      url,
    ...
    return isTruncated ? import_react251.default.createElement(Tooltip, {
  ...
  }, displayActionsOnHover && secondaryActionMarkup && wrappedBadgeMarkup ? import_react251.default.createElement("span", {
    className: styles102.ItemWithFloatingActions
  }, itemLinkMarkup(), secondaryActionMarkup) : import_react251.default.createElement(import_react251.default.Fragment, null, itemLinkMarkup(), secondaryActionMarkup), outerContentMarkup)), secondaryNavigationMarkup);
...
function ItemSecondaryAction({
  ...
  const markup = url ? import_react251.default.createElement(UnstyledLink, {
    external: true,
    url,
    ...
    source: icon
  })) : import_react251.default.createElement(UnstyledButton, {
    className: styles102.SecondaryAction,
    tabIndex,
    disabled,
    accessibilityLabel,
  ...
  return tooltip ? import_react251.default.createElement(Tooltip, tooltip, " ", markup, " ") : markup;
}
...
function Section7({
  ...
  const animationFrame = (0, import_react252.useRef)(null);
  const {
    isNavigationCollapsed
  } = useMediaQuery2();
  const [expandedIndex, setExpandedIndex] = (0, import_react252.useState)();
  ...
  const buttonMarkup = action && import_react252.default.createElement("button", {
    type: "button",
  ...
  const actionMarkup = action && (action.tooltip ? import_react252.default.createElement(Tooltip, action.tooltip, buttonMarkup) : buttonMarkup);
  const sectionHeadingMarkup = title && import_react252.default.createElement("li", {
    className: styles102.SectionHeading
  }, import_react252.default.createElement(Text, {
    as: "span",
    variant: "bodySm",
    fontWeight: "medium",
    tone: "subdued"
  ...
  const itemsMarkup = items.map((item, index) => {
    ...
    return import_react252.default.createElement(Item11, Object.assign({
      key: label
    }, rest, {
      label,
      subNavigationItems,
  ...
  const toggleRollup = rollup && items.length > rollup.after && import_react252.default.createElement("div", {
    className: styles102.ListItem,
    key: "List Item"
  ...
  const additionalItemsId = (0, import_react252.useId)();
  const activeItemsMarkup = rollup && additionalItems.length > 0 && import_react252.default.createElement("li", {
    className: styles102.RollupSection
  }, import_react252.default.createElement(Collapsible, {
    id: additionalItemsId,
    open: expanded
  }, import_react252.default.createElement("ul", {
    className: styles102.List
  }, additionalItems)), toggleRollup);
  return import_react252.default.createElement("ul", {
    className
...
var Navigation2 = function Navigation3({
  ...
  const logoMarkup = logo ? import_react253.default.createElement("div", {
    className: classNames(styles102.LogoContainer, logoSuffix && styles102.hasLogoSuffix)
  }, import_react253.default.createElement(UnstyledLink, {
    url: logo.url || "",
    className: styles102.LogoLink,
    style: {
      width
    }
  }, import_react253.default.createElement(Image, {
  ...
  const mediaMarkup = contextControl ? import_react253.default.createElement("div", {
    className: styles102.ContextControl
  }, contextControl) : logoMarkup;
  const context = (0, import_react253.useMemo)(() => ({
    location,
    onNavigationDismiss: onDismiss
  }), [location, onDismiss]);
  return import_react253.default.createElement(NavigationContext.Provider, {
    value: context
  }, import_react253.default.createElement(WithinContentContext.Provider, {
    value: true
  }, import_react253.default.createElement("nav", {
    className: styles102.Navigation,
    "aria-labelledby": ariaLabelledBy
  }, mdUp ? mediaMarkup : null, import_react253.default.createElement(Scrollable, {
...
function Option3({
  ...
  const handleClick = (0, import_react254.useCallback)(() => {
    if (disabled) {
      return;
    }
    onClick(section, index);
  }, [disabled, index, onClick, section]);
  const handlePointerEnter = (0, import_react254.useCallback)(() => {
    if (disabled) {
      return;
    }
    onPointerEnter(section, index);
  }, [disabled, onPointerEnter, section, index]);
  const handleFocus = (0, import_react254.useCallback)(() => {
    toggleFocused();
    onFocus(section, index);
  }, [toggleFocused, onFocus, section, index]);
  const mediaMarkup = media ? import_react254.default.createElement("div", {
  ...
  const optionMarkup = allowMultiple ? import_react254.default.createElement("label", {
    htmlFor: id,
    className: multiSelectClassName
  }, import_react254.default.createElement("div", {
    className: styles103.Checkbox
  }, import_react254.default.createElement(Checkbox, {
    id,
    label: "",
  ...
  })), mediaMarkup, import_react254.default.createElement("span", {
    id: `${id}-label`
  }, label)) : import_react254.default.createElement("button", {
    id,
    type: "button",
  ...
  }, import_react254.default.createElement(import_react254.default.Fragment, null, import_react254.default.createElement(InlineStack, {
    wrap: false,
    blockAlign: verticalAlignToBlockAlign(verticalAlign)
  }, mediaMarkup, label), (select || active) && import_react254.default.createElement("span", {
    className: styles103.Icon
  }, import_react254.default.createElement(Icon, {
    source: SvgCheckIcon
  }))));
  const scrollMarkup = active ? import_react254.default.createElement(Scrollable.ScrollTo, null) : null;
  return import_react254.default.createElement("li", {
    key: id,
...
function OptionList({
  ...
  const [normalizedOptions, setNormalizedOptions] = (0, import_react255.useState)(createNormalizedOptions(options, sections, title));
  const uniqId = (0, import_react255.useId)();
  const id = idProp ?? uniqId;
  useDeepEffect(() => {
    setNormalizedOptions(createNormalizedOptions(options || [], sections || [], title));
  }, [options, sections, title], optionArraysAreEqual);
  const handleClick = (0, import_react255.useCallback)((sectionIndex, optionIndex) => {
  ...
  const handlePointerEnter = (0, import_react255.useCallback)((sectionIndex, optionIndex) => {
    if (!onPointerEnterOption) return;
    const selectedValue = normalizedOptions[sectionIndex].options[optionIndex].value;
    onPointerEnterOption(selectedValue);
  }, [normalizedOptions, onPointerEnterOption]);
  const handleFocus = (0, import_react255.useCallback)((sectionIndex, optionIndex) => {
  ...
  const optionsMarkup = optionsExist ? normalizedOptions.map(({
    ...
    const titleMarkup = title2 ? import_react255.default.createElement(Box, {
      paddingBlockStart: isFirstOption ? "050" : "300",
      paddingInlineStart: "150",
      paddingBlockEnd: "100",
      paddingInlineEnd: "150",
      borderColor: "border-secondary"
    }, import_react255.default.createElement(Text, {
      as: titleLevel,
      variant: "headingSm"
    }, title2)) : null;
    const optionsMarkup2 = options2 && options2.map((option2, optionIndex) => {
      ...
      return import_react255.default.createElement(Option3, Object.assign({
        key: optionId
      }, option2, {
        id: optionId,
    ...
    const option = import_react255.default.createElement(Box, {
      as: "ul",
      id: `${id}-${sectionIndex}`,
      role
    }, optionsMarkup2);
    const blockStartPadding = isFirstOption ? title2 ? "100" : "0" : title2 ? "050" : "0";
    return import_react255.default.createElement(Box, {
...
function isInterface(x) {
  return !(0, import_react256.isValidElement)(x) && x !== void 0;
}
...
function isReactElement(x) {
  return (0, import_react257.isValidElement)(x) && x !== void 0;
}
...
function Title({
  ...
  const titleMarkup = title ? import_react258.default.createElement("h1", {
    className
  ...
  const titleMetadataMarkup = titleMetadata ? import_react258.default.createElement(Bleed, {
    marginBlock: "100"
  }, titleMetadata) : null;
  const wrappedTitleMarkup = import_react258.default.createElement("div", {
    className: styles106.TitleWrapper
  }, titleMarkup, titleMetadataMarkup);
  const subtitleMarkup = subtitle ? import_react258.default.createElement("div", {
  ...
  return import_react258.default.createElement(import_react258.default.Fragment, null, wrappedTitleMarkup, subtitleMarkup);
}
...
function Header4({
  ...
  const breadcrumbMarkup = backAction ? import_react259.default.createElement("div", {
    className: styles105.BreadcrumbWrapper
  }, import_react259.default.createElement(Box, {
    maxWidth: "100%",
    paddingInlineEnd: "100",
    printHidden: true
  }, import_react259.default.createElement(Breadcrumbs, {
    backAction
  }))) : null;
  const paginationMarkup = pagination && !isNavigationCollapsed ? import_react259.default.createElement("div", {
    className: styles105.PaginationWrapper
  }, import_react259.default.createElement(Box, {
    printHidden: true
  }, import_react259.default.createElement(Pagination, Object.assign({}, pagination, {
    hasPrevious: pagination.hasPrevious,
    hasNext: pagination.hasNext
  })))) : null;
  const pageTitleMarkup = import_react259.default.createElement("div", {
    className: classNames(styles105.TitleWrapper, !hasActionGroupsOrSecondaryActions && styles105.TitleWrapperExpand)
  }, import_react259.default.createElement(Title, {
    title,
    subtitle,
    titleMetadata,
    compactTitle,
  ...
  const pageReadyAccessibilityLabelMarkup = labelForPageReadyAccessibilityLabel ? import_react259.default.createElement("div", {
    role: "status"
  ...
  const primaryActionMarkup = primaryAction ? import_react259.default.createElement(PrimaryActionMarkup, {
    primaryAction
  }) : null;
  let actionMenuMarkup = null;
  if (isInterface(secondaryActions) && (secondaryActions.length > 0 || hasGroupsWithActions(actionGroups))) {
    actionMenuMarkup = import_react259.default.createElement(ActionMenu, {
    ...
    actionMenuMarkup = import_react259.default.createElement(import_react259.default.Fragment, null, secondaryActions);
  }
  const navigationMarkup = breadcrumbMarkup || paginationMarkup ? import_react259.default.createElement(Box, {
    printHidden: true,
    paddingBlockEnd: "100",
    paddingInlineEnd: actionMenuMarkup && isNavigationCollapsed ? "1000" : void 0
  }, import_react259.default.createElement(InlineStack, {
    gap: "400",
    align: "space-between",
    blockAlign: "center"
  }, breadcrumbMarkup, paginationMarkup)) : null;
  const additionalMetadataMarkup = additionalMetadata ? import_react259.default.createElement("div", {
  ...
  return import_react259.default.createElement(Box, {
    position: "relative",
    paddingBlockStart: {
      xs: "400",
      md: "600"
    ...
    visuallyHidden: titleHidden
  }, pageReadyAccessibilityLabelMarkup, import_react259.default.createElement("div", {
    className: headerClassNames
  }, import_react259.default.createElement(FilterActionsProvider, {
    filterActions: Boolean(filterActions)
  }, import_react259.default.createElement(ConditionalRender, {
    condition: [slot1, slot2, slot3, slot4].some(notNull)
  }, import_react259.default.createElement("div", {
    className: styles105.Row
  }, slot1, slot2, import_react259.default.createElement(ConditionalRender, {
    condition: [slot3, slot4].some(notNull)
  }, import_react259.default.createElement("div", {
    className: styles105.RightAlign
  }, import_react259.default.createElement(ConditionalWrapper, {
    condition: [slot3, slot4].every(notNull),
    wrapper: (children) => import_react259.default.createElement("div", {
      className: styles105.Actions
    }, children)
  }, slot3, slot4))))), import_react259.default.createElement(ConditionalRender, {
...
function PrimaryActionMarkup({
  ...
  if (isInterface(primaryAction)) {
    ...
    actionMarkup = helpText ? import_react259.default.createElement(Tooltip, {
      content: helpText
    }, content) : content;
  } else {
  ...
  const layouts = {
    ...
    desktopDefault: {
      slots: {
        slot1: breadcrumbMarkup,
        slot2: pageTitleMarkup,
        slot3: import_react259.default.createElement(import_react259.default.Fragment, null, actionMenuMarkup, primaryActionMarkup),
...
function Page({
  ...
  const headerMarkup = hasHeaderContent ? import_react260.default.createElement(Header4, Object.assign({
    filterActions: true
  }, rest)) : null;
  return import_react260.default.createElement("div", {
    className: pageClassName
  }, headerMarkup, import_react260.default.createElement("div", {
    className: contentClassName
  }, children));
}
...
function PageActions({
  ...
  if (isReactElement(primaryAction)) {
    primaryActionMarkup = import_react261.default.createElement(import_react261.default.Fragment, null, primaryAction);
  ...
  if (isInterface(secondaryActions) && secondaryActions.length > 0) {
    secondaryActionsMarkup = import_react261.default.createElement(ButtonGroup, null, buttonsFrom(secondaryActions));
  } else if (isReactElement(secondaryActions)) {
    secondaryActionsMarkup = import_react261.default.createElement(import_react261.default.Fragment, null, secondaryActions);
  }
  return import_react261.default.createElement("div", {
    className: styles107.PageActions
  }, import_react261.default.createElement(LegacyStack, {
...
// node_modules/@shopify/polaris/build/esm/components/Picker/components/Activator/Activator.js
var Activator = (0, import_react262.forwardRef)(({
  disabled,
  label,
  placeholder,
  selected,
  ...
  return import_react262.default.createElement("button", {
    ref,
    disabled,
    onClick,
    ...
    as: "span",
    gap: "100"
  }, label && import_react262.default.createElement(Text, {
    as: "span",
    variant: "bodySm",
    alignment: "start",
    tone: "subdued"
  }, label), (selected !== "" || placeholder) && import_react262.default.createElement(Text, {
    as: "span",
    variant: "bodyMd",
    alignment: "start",
    tone: selected ? void 0 : "subdued"
  }, selected || placeholder)), import_react262.default.createElement("span", null, import_react262.default.createElement(Icon, {
    tone: "subdued",
...
function SearchField2({
  ...
  const inputRef = import_react263.default.useRef(null);
  const comboboxTextFieldContext = useComboboxTextField();
  const {
    activeOptionId,
    listboxId,
  ...
  const uniqueId = (0, import_react263.useId)();
  const textFieldId = (0, import_react263.useMemo)(() => idProp || uniqueId, [uniqueId, idProp]);
  const labelId = (0, import_react263.useMemo)(() => labelID(idProp || uniqueId), [uniqueId, idProp]);
  (0, import_react263.useEffect)(() => {
    if (setTextFieldLabelId) setTextFieldLabelId(labelId);
  }, [labelId, setTextFieldLabelId]);
  const handleFocus = (0, import_react263.useCallback)((event) => {
    if (onFocus) onFocus(event);
    if (onTextFieldFocus) onTextFieldFocus();
    if (setTextFieldFocused) setTextFieldFocused(true);
  }, [onFocus, onTextFieldFocus, setTextFieldFocused]);
  const handleBlur = (0, import_react263.useCallback)((event) => {
    if (onBlur) onBlur(event);
    if (onTextFieldBlur) onTextFieldBlur();
    if (setTextFieldFocused) setTextFieldFocused(false);
  }, [onBlur, onTextFieldBlur, setTextFieldFocused]);
  const handleChange = (0, import_react263.useCallback)((value2, id) => {
    if (onChange) onChange(value2, id);
    if (onTextFieldChange) onTextFieldChange(value2);
  }, [onChange, onTextFieldChange]);
  ...
  return import_react263.default.createElement(InlineStack, {
    gap: "100",
    blockAlign: "center"
  }, import_react263.default.createElement(Label, {
    id: textFieldId
  }, import_react263.default.createElement(Text, {
    as: "span",
    visuallyHidden: true
  }, label), import_react263.default.createElement("span", null, prefix)), import_react263.default.createElement("input", {
    ref: inputRef,
    id: textFieldId,
...
function Picker({
  ...
  const activatorRef = (0, import_react264.createRef)();
  const [activeItems, setActiveItems] = (0, import_react264.useState)([]);
  const [popoverActive, setPopoverActive] = (0, import_react264.useState)(false);
  const [activeOptionId, setActiveOptionId] = (0, import_react264.useState)();
  const [textFieldLabelId, setTextFieldLabelId] = (0, import_react264.useState)();
  const [listboxId, setListboxId] = (0, import_react264.useState)();
  const [query, setQuery] = (0, import_react264.useState)("");
  const filteredOptions = (0, import_react264.useRef)(options);
  const shouldOpen = !popoverActive;
  const handleClose = (0, import_react264.useCallback)(() => {
    setPopoverActive(false);
    onClose?.();
    activatorRef.current?.focus();
  }, [activatorRef, onClose]);
  const handleOpen = (0, import_react264.useCallback)(() => {
    setPopoverActive(true);
    filteredOptions.current = options;
  }, [options]);
  const handleFocus = (0, import_react264.useCallback)(() => {
    if (shouldOpen) handleOpen();
  }, [shouldOpen, handleOpen]);
  const handleChange = (0, import_react264.useCallback)(() => {
    if (shouldOpen) handleOpen();
  }, [shouldOpen, handleOpen]);
  const handleBlur = (0, import_react264.useCallback)(() => {
    if (popoverActive) {
      handleClose();
      setQuery("");
    }
  }, [popoverActive, handleClose]);
  const textFieldContextValue = (0, import_react264.useMemo)(() => ({
    activeOptionId,
    expanded: popoverActive,
    listboxId,
    setTextFieldLabelId,
  ...
  const listboxOptionContextValue = (0, import_react264.useMemo)(() => ({
    allowMultiple
  }), [allowMultiple]);
  const listboxContextValue = (0, import_react264.useMemo)(() => ({
    listboxId,
    textFieldLabelId,
  ...
  const updateText = (0, import_react264.useCallback)((value) => {
    setQuery(value);
    if (value === "") {
      filteredOptions.current = options;
      return;
  ...
  const handleSelect = (0, import_react264.useCallback)((selected) => {
    setQuery("");
    updateText("");
  ...
  return import_react264.default.createElement(Popover2, {
    activator: import_react264.default.createElement(Activator, Object.assign({}, activator, {
      onClick: handleOpen,
    ...
    preventFocusOnClose: true
  }, import_react264.default.createElement(Popover2.Pane, {
    onScrolledToBottom,
    height
  }, searchField ? import_react264.default.createElement(Box, {
    paddingBlockStart: "200",
    paddingBlockEnd: "100",
    paddingInline: "200",
    borderBlockEndWidth: "025",
    borderColor: "border",
    minHeight: showList ? void 0 : "58px"
  }, import_react264.default.createElement(ComboboxTextFieldContext.Provider, {
    value: textFieldContextValue
  }, import_react264.default.createElement(SearchField2, Object.assign({}, searchField, {
    value: query,
    onChange: (value) => {
      updateText(value);
      searchField.onChange?.(value, searchField.id ?? "");
    },
    prefix: import_react264.default.createElement(Icon, {
      source: SvgSearchIcon
    }),
    labelHidden: true,
    focused: popoverActive
  })))) : null, showList && import_react264.default.createElement(ComboboxListboxContext.Provider, {
    value: listboxContextValue
  }, import_react264.default.createElement(ComboboxListboxOptionContext.Provider, {
    value: listboxOptionContextValue
  }, import_react264.default.createElement(Box, {
    paddingBlock: "200"
  }, import_react264.default.createElement(Listbox, Object.assign({}, listboxProps, {
    onSelect: handleSelect
  }), filteredOptions.current?.map((option) => import_react264.default.createElement(Listbox.Option, Object.assign({
    key: option.value,
    selected: activeItems.some((item) => item === option.value)
  }, option))), addAction && query !== "" && !queryMatchesExistingOption ? import_react264.default.createElement(Listbox.Action, Object.assign({}, addAction, {
    value: query
  })) : null))))));
}
var reactChildrenText = (children) => {
  if (typeof children === "string") return children;
  return (0, import_react264.isValidElement)(children) ? reactChildrenText(children?.props?.children) : "";
};
...
function PolarisTestProvider({
  ...
  const Wrapper = strict ? import_react265.StrictMode : import_react265.Fragment;
  const intl = (0, import_react265.useMemo)(() => new I18n(i18n || {}), [i18n]);
  const scrollLockManager = (0, import_react265.useMemo)(() => new ScrollLockManager(), []);
  const stickyManager = (0, import_react265.useMemo)(() => new StickyManager(), []);
  const mergedFrame = createFrameContext(frame);
  const mergedMediaQuery = merge(defaultMediaQuery, mediaQuery);
  return import_react265.default.createElement(Wrapper, null, import_react265.default.createElement(ThemeNameContext.Provider, {
    value: themeName
  }, import_react265.default.createElement(ThemeContext.Provider, {
    value: getTheme(themeName)
  }, import_react265.default.createElement(FeaturesContext.Provider, {
    value: features
  }, import_react265.default.createElement(I18nContext.Provider, {
    value: intl
  }, import_react265.default.createElement(ScrollLockManagerContext.Provider, {
    value: scrollLockManager
  }, import_react265.default.createElement(StickyManagerContext.Provider, {
    value: stickyManager
  }, import_react265.default.createElement(LinkContext.Provider, {
    value: link
  }, import_react265.default.createElement(MediaQueryContext.Provider, {
    value: mergedMediaQuery
  }, import_react265.default.createElement(PortalsManager, null, import_react265.default.createElement(FocusManager, null, import_react265.default.createElement(EphemeralPresenceManager, null, import_react265.default.createElement(FrameContext.Provider, {
    value: mergedFrame
  }, children)))))))))))));
}
function noop18() {
...
function createFrameContext({
  ...
  hideToast = noop18,
  toastMessages = [],
  setContextualSaveBar = noop18,
  removeContextualSaveBar = noop18,
...
function ProgressBar({
  ...
  const theme = useTheme();
  const i18n = useI18n();
  const indicatorRef = (0, import_react266.useRef)(null);
  const className = classNames(styles110.ProgressBar, size && styles110[variationName("size", size)], tone && styles110[variationName("tone", tone)]);
  ...
  return import_react266.default.createElement("div", {
    className
  }, import_react266.default.createElement("progress", {
    "aria-labelledby": ariaLabelledBy,
    className: styles110.Progress,
    value: parsedProgress,
    max: "100"
  }), import_react266.default.createElement(CSSTransition_default, {
    in: true,
    appear: true,
...
var DualThumb = class extends import_react267.Component {
  constructor(...args) {
    super(...args);
    this.state = {
    ...
    this.track = (0, import_react267.createRef)();
    this.trackWrapper = (0, import_react267.createRef)();
    this.thumbLower = (0, import_react267.createRef)();
    this.thumbUpper = (0, import_react267.createRef)();
  ...
  render() {
    ...
    const outputMarkupLower = !disabled && output ? import_react267.default.createElement("output", {
      htmlFor: idLower,
    ...
    }, import_react267.default.createElement(Text, {
      as: "span",
      variant: "headingSm",
      alignment: "center"
    }, value[0]))) : null;
    const outputUpperClassName = classNames(styles111.Output, styles111.OutputUpper);
    const outputMarkupUpper = !disabled && output ? import_react267.default.createElement("output", {
      htmlFor: idUpper,
    ...
    const prefixMarkup = prefix && import_react267.default.createElement("div", {
      className: styles111.Prefix
    }, prefix);
    const suffixMarkup = suffix && import_react267.default.createElement("div", {
      className: styles111.Suffix
    }, suffix);
    return import_react267.default.createElement(import_react267.default.Fragment, null, import_react267.default.createElement(Labelled, {
      id,
      label,
      error,
      action: labelAction,
    ...
    }, prefixMarkup, import_react267.default.createElement("div", {
      ...
      ref: this.thumbLower
    }), outputMarkupLower, import_react267.default.createElement("div", {
      id: idUpper,
      ...
      ref: this.thumbUpper
    }), outputMarkupUpper), suffixMarkup)), import_react267.default.createElement(EventListener, {
      event: "resize",
...
function SingleThumb(props) {
  ...
  const outputMarkup = !disabled && output && import_react268.default.createElement("output", {
    htmlFor: id,
    className: styles112.Output
  }, import_react268.default.createElement("div", {
    className: styles112.OutputBubble
  }, import_react268.default.createElement(Text, {
    as: "span",
    variant: "headingSm",
    alignment: "center"
  }, clampedValue)));
  const prefixMarkup = prefix && import_react268.default.createElement("div", {
    className: styles112.Prefix
  }, prefix);
  const suffixMarkup = suffix && import_react268.default.createElement("div", {
  ...
  return import_react268.default.createElement(Labelled, {
    id,
    label,
    error,
    action: labelAction,
    ...
    className,
    style: cssVars
  }, prefixMarkup, import_react268.default.createElement("div", {
    className: classNames(styles112.InputWrapper, sharedStyles["Track--dashed-after"])
  }, import_react268.default.createElement("input", {
    type: "range",
...
function RangeSlider({
  ...
  const id = (0, import_react269.useId)();
  const sharedProps = {
    id,
    min,
    max,
  ...
  return isDualThumb(value) ? import_react269.default.createElement(DualThumb, Object.assign({
    value
  }, sharedProps)) : import_react269.default.createElement(SingleThumb, Object.assign({
    value
  }, sharedProps));
}
...
// node_modules/@shopify/polaris/build/esm/components/ResourceItem/ResourceItem.js
var BaseResourceItem = class extends import_react270.Component {
  constructor(...args) {
    super(...args);
    this.state = {
    ...
    this.node = null;
    this.overlayRef = (0, import_react270.createRef)();
    this.buttonOverlay = (0, import_react270.createRef)();
    this.setNode = (node) => {
      this.node = node;
    };
    this.handleFocus = (event) => {
  ...
  render() {
    ...
    if (selectable) {
      ...
      handleMarkup = import_react270.default.createElement("div", {
        className: styles113.CheckboxWrapper,
        onClick: stopPropagation2,
        onChange: this.handleLargerSelectionArea
      }, import_react270.default.createElement(UseId, null, (id) => import_react270.default.createElement(Checkbox, {
        id,
    ...
    if (media || selectable) {
      ownedMarkup = import_react270.default.createElement(InlineStack, {
        gap: "300",
    ...
    if (shortcutActions && !loading) {
      if (persistActions) {
        actionsMarkup = breakpoints?.lgUp ? import_react270.default.createElement("div", {
          className: styles113.Actions,
          onClick: stopPropagation2
        }, import_react270.default.createElement(ButtonGroup, null, buttonsFrom(shortcutActions, {
          variant: "tertiary"
        }))) : null;
        const disclosureAccessibilityLabel = name ? i18n.translate("Polaris.ResourceList.Item.actionsDropdownLabel", {
          accessibilityLabel: name
        }) : i18n.translate("Polaris.ResourceList.Item.actionsDropdown");
        disclosureMarkup = !selectMode && breakpoints?.lgDown ? import_react270.default.createElement("div", {
          onClick: stopPropagation2
        }, import_react270.default.createElement(Popover2, {
          activator: import_react270.default.createElement(Button, {
        ...
        }, import_react270.default.createElement(ActionList, {
          items: shortcutActions
        }))) : null;
      } else if (breakpoints?.lgUp) {
        actionsMarkup = import_react270.default.createElement("div", {
          className: styles113.Actions,
          onClick: stopPropagation2
        }, import_react270.default.createElement(Box, {
          position: "absolute",
          insetBlockStart: "400",
          insetInlineEnd: "500"
        }, import_react270.default.createElement(ButtonGroup, {
          variant: "segmented"
    ...
    const containerMarkup = import_react270.default.createElement(Box, {
      id: this.props.id,
      position: "relative",
      paddingInlineStart: "300",
      paddingInlineEnd: "300",
    ...
    }, import_react270.default.createElement(InlineGrid, {
      columns: {
        xs: "1fr auto"
      }
    }, import_react270.default.createElement(InlineGrid, {
    ...
    const accessibleMarkup = url ? import_react270.default.createElement(UseId, null, (id) => import_react270.default.createElement(UnstyledLink, {
      ...
      id,
      ref: this.overlayRef
    })) : import_react270.default.createElement("button", {
    ...
    return import_react270.default.createElement("li", {
...
function ResourceItem(props) {
  const breakpoints = useBreakpoints();
  return import_react270.default.createElement(BaseResourceItem, Object.assign({}, props, {
    breakpoints,
    context: (0, import_react270.useContext)(ResourceListContext),
    i18n: useI18n()
  }));
}
...
function UseId(props) {
  const id = (0, import_react270.useId)();
...
function Select({
  ...
  const uniqId = (0, import_react271.useId)();
  const id = idProp ?? uniqId;
  ...
  const handleFocus = (0, import_react271.useCallback)((event) => {
    toggleFocused();
    onFocus?.(event);
  }, [onFocus, toggleFocused]);
  const handleBlur = (0, import_react271.useCallback)((event) => {
    toggleFocused();
    onBlur?.(event);
  }, [onBlur, toggleFocused]);
  ...
  const inlineLabelMarkup = labelInline && import_react271.default.createElement(Box, {
    paddingInlineEnd: "100"
  ...
  const prefixMarkup = selectedOption.prefix && import_react271.default.createElement("div", {
    className: styles115.Prefix
  }, selectedOption.prefix);
  const contentMarkup = import_react271.default.createElement("div", {
    className: styles115.Content,
    "aria-hidden": true,
    "aria-disabled": disabled
  }, inlineLabelMarkup, prefixMarkup, import_react271.default.createElement("span", {
    className: styles115.SelectedOption
  }, selectedOption.label), import_react271.default.createElement("span", {
    className: styles115.Icon
  }, import_react271.default.createElement(Icon, {
    source: SvgSelectIcon
  })));
  ...
  return import_react271.default.createElement(Labelled, {
    ...
    className
  }, import_react271.default.createElement("select", {
    id,
    name,
    value,
    ...
    "aria-describedby": describedBy.length ? describedBy.join(" ") : void 0,
    "aria-required": requiredIndicator
  }, optionsMarkup), contentMarkup, import_react271.default.createElement("div", {
...
function renderSingleOption(option) {
  ...
  return import_react271.default.createElement("option", Object.assign({
    key: key ?? value,
    value
  }, rest), label);
}
function renderOption(optionOrGroup) {
  if (isGroup(optionOrGroup)) {
    ...
    return import_react271.default.createElement("optgroup", {
      label: title,
      key: title
...
function ResourceList({
  ...
  const i18n = useI18n();
  const [selectMode, setSelectMode] = (0, import_react272.useState)(Boolean(selectedItems && selectedItems.length > 0));
  const [loadingPosition, setLoadingPositionState] = (0, import_react272.useState)(0);
  const [lastSelected, setLastSelected] = (0, import_react272.useState)();
  const [smallScreen, setSmallScreen] = (0, import_react272.useState)(isBreakpointsXS());
  const forceUpdate = (0, import_react272.useReducer)((x = 0) => x + 1, 0)[1];
  const checkableButtonRef = (0, import_react272.useRef)(null);
  ...
  const selectAllSelectState = (0, import_react272.useMemo)(() => {
  ...
  const [selectedItemsCount, setSelectedItemsCount] = (0, import_react272.useState)(selectedItems === SELECT_ALL_ITEMS2 ? `${items.length}+` : selectedItems.length);
  ...
  const bulkActionsAccessibilityLabel = (0, import_react272.useMemo)(() => {
  ...
  const paginatedSelectAllText = (0, import_react272.useMemo)(() => {
  ...
  const handleSelectAllItemsInStore = (0, import_react272.useCallback)(() => {
  ...
  const paginatedSelectAllAction = (0, import_react272.useMemo)(() => {
    if (!isSelectable || !hasMoreItems) {
      return;
    }
  ...
  const setLoadingPosition = (0, import_react272.useCallback)(() => {
  ...
  const bulkActionsMarkup = isSelectable ? import_react272.default.createElement("div", {
    className: bulkActionClassNames
  }, import_react272.default.createElement(BulkActions, {
    selectMode,
  ...
  const filterControlMarkup = filterControl ? import_react272.default.createElement("div", {
    className: classNames(!flushFilters && styles114.FiltersWrapper)
  }, filterControl) : null;
  const sortingSelectMarkup = sortOptions && sortOptions.length > 0 && !alternateTool ? import_react272.default.createElement("div", {
    className: styles114.SortWrapper
  }, import_react272.default.createElement(Select, {
  ...
  const alternateToolMarkup = alternateTool && !sortingSelectMarkup ? import_react272.default.createElement("div", {
    className: styles114.AlternateToolWrapper
  }, alternateTool) : null;
  const headerTitleMarkup = import_react272.default.createElement("div", {
    className: styles114.HeaderTitleWrapper
  }, import_react272.default.createElement(Text, {
    as: "span",
    variant: "bodyMd"
  }, headerTitle()));
  const selectButtonMarkup = isSelectable ? import_react272.default.createElement("div", {
    className: styles114.SelectButtonWrapper
  }, import_react272.default.createElement(Button, {
    disabled: selectMode,
    icon: SvgCheckboxIcon,
    onClick: () => handleSelectMode(true)
  }, i18n.translate("Polaris.ResourceList.selectButtonText"))) : null;
  const checkableButtonMarkup = isSelectable ? import_react272.default.createElement("div", {
    className: styles114.CheckableButtonWrapper
  }, import_react272.default.createElement(CheckableButton, {
    accessibilityLabel: bulkActionsAccessibilityLabel,
    label: headerTitle(),
    onToggleAll: handleToggleAll,
    disabled: loading,
  ...
  const headerWrapperOverlay = loading ? import_react272.default.createElement("div", {
  ...
  const headerMarkup = !showEmptyState && showHeader !== false && !showEmptySearchState && (showHeader || needsHeader) && listRef.current && import_react272.default.createElement("div", {
    className: styles114.HeaderOuterWrapper
  }, import_react272.default.createElement(Sticky, {
    ...
    return import_react272.default.createElement("div", {
      className: headerClassName
    }, headerWrapperOverlay, import_react272.default.createElement("div", {
  ...
  const emptySearchStateMarkup = showEmptySearchState ? emptySearchState || import_react272.default.createElement("div", {
    className: styles114.EmptySearchResultWrapper
  }, import_react272.default.createElement(EmptySearchResult, Object.assign({}, emptySearchResultText, {
    withIllustration: true
  }))) : null;
  ...
  const loadingOverlay = loading ? import_react272.default.createElement(import_react272.default.Fragment, null, import_react272.default.createElement("li", {
    className: styles114.SpinnerContainer,
    style: spinnerStyle
  }, import_react272.default.createElement(Spinner, {
    size: spinnerSize,
    accessibilityLabel: "Items are loading"
  })), import_react272.default.createElement("li", {
  ...
  const loadingWithoutItemsMarkup = loading && !itemsExist ? import_react272.default.createElement("div", {
    className,
    tabIndex: -1
  }, loadingOverlay) : null;
  ...
  const listMarkup = itemsExist ? import_react272.default.createElement("ul", {
    className: resourceListClassName,
    ref: listRef,
    "aria-live": "polite",
    "aria-busy": loading
  }, loadingOverlay, import_react272.Children.toArray(items.map(renderItemWithId))) : null;
  const paginationMarkup = pagination ? import_react272.default.createElement("div", {
    className: styles114.PaginationWrapper
  }, import_react272.default.createElement(Pagination, Object.assign({
    type: "table"
  }, pagination))) : null;
  const context = {
  ...
  return import_react272.default.createElement(ResourceListContext.Provider, {
    value: context
  }, filterControlMarkup, import_react272.default.createElement("div", {
...
// node_modules/@shopify/polaris/build/esm/components/SelectAllActions/SelectAllActions.js
var SelectAllActions = (0, import_react273.forwardRef)(function SelectAllActions2({
  label,
  selectMode,
  paginatedSelectAllText,
  paginatedSelectAllAction,
  ...
  const nodeRef = (0, import_react273.useRef)(null);
  const paginatedSelectAllMarkup = paginatedSelectAllAction ? import_react273.default.createElement(UnstyledButton, {
    className: styles116.AllAction,
    onClick: paginatedSelectAllAction.onAction,
    size: "slim",
    disabled
  }, import_react273.default.createElement(Text, {
    as: "span",
    variant: "bodySm",
    fontWeight: "medium"
  }, paginatedSelectAllAction.content)) : null;
  ...
  const checkableButtonMarkup = accessibilityLabel && onToggleAll ? import_react273.default.createElement(CheckableButton, checkableButtonProps) : null;
  const markup = import_react273.default.createElement(Transition_default, {
    timeout: 0,
    in: selectMode,
    key: "markup",
    nodeRef
    ...
    return import_react273.default.createElement("div", {
      ...
      paddingInlineStart: "300",
      paddingInlineEnd: "400"
    }, import_react273.default.createElement(InlineStack, {
      gap: "200",
      align: "start",
      blockAlign: "center"
    }, checkableButtonMarkup, import_react273.default.createElement(Text, {
      as: "span",
      variant: "bodySm",
      fontWeight: "medium"
...
function SettingToggle({
  ...
  const id = (0, import_react274.useId)();
  if (true) {
  ...
  return import_react274.default.createElement(LegacyCard, {
    sectioned: true
  }, import_react274.default.createElement(SettingAction, {
    action: actionMarkup
...
function SkeletonBodyText({
  ...
  for (let i = 0; i < lines; i++) {
    bodyTextLines.push(import_react275.default.createElement("div", {
...
function SkeletonDisplayText({
  ...
  const className = classNames(styles118.DisplayText, size && styles118[variationName("size", size)]);
  const style = {
...
function SkeletonPage({
  ...
  const i18n = useI18n();
  const titleContent = title ? import_react277.default.createElement(Text, {
    as: "h1",
    variant: "headingLg",
    fontWeight: "bold"
  }, title) : import_react277.default.createElement("div", {
  ...
  const primaryActionMarkup = primaryAction ? import_react277.default.createElement(Box, {
  ...
  const backActionMarkup = backAction ? import_react277.default.createElement(Box, {
    borderRadius: "100",
    background: "bg-fill-tertiary",
    minHeight: "2.25rem",
    minWidth: "2.25rem",
  ...
  return import_react277.default.createElement(BlockStack, {
    gap: "400",
    inlineAlign: "center"
  }, import_react277.default.createElement(Box, Object.assign({
    width: "100%",
    padding: "0",
    paddingInlineStart: {
      sm: "600"
    ...
    maxWidth: "none"
  }), import_react277.default.createElement(BlockStack, null, import_react277.default.createElement(Box, {
    paddingBlockStart: {
      xs: "400",
      md: "500"
    },
    ...
    width: "100%"
  }, import_react277.default.createElement(InlineStack, {
    gap: "400",
    align: "space-between",
    blockAlign: "center"
  }, import_react277.default.createElement(InlineStack, {
    gap: "400"
  }, backActionMarkup, import_react277.default.createElement(Box, {
    paddingBlockStart: "100",
    paddingBlockEnd: "100"
  }, titleContent)), primaryActionMarkup)), import_react277.default.createElement(Box, {
    paddingBlockEnd: "200",
    width: "100%"
  }, children))));
}
...
function SkeletonThumbnail({
  ...
  const className = classNames(styles121.SkeletonThumbnail, size && styles121[variationName("size", size)]);
...
function Thumbnail({
  ...
  const className = classNames(styles122.Thumbnail, size && styles122[variationName("size", size)], transparent && styles122.transparent);
  const content = typeof source === "string" ? import_react280.default.createElement(Image, {
    alt,
    source
  }) : import_react280.default.createElement(Icon, {
    accessibilityLabel: alt,
    source
  });
  return import_react280.default.createElement("span", {
    className
  }, content);
}
...
var Toast2 = (0, import_react281.memo)(function Toast3(props) {
...
function SearchDismissOverlay({
  ...
  const node = (0, import_react282.useRef)(null);
  const handleDismiss = (0, import_react282.useCallback)(({
    target
  }) => {
  ...
  return import_react282.default.createElement(import_react282.default.Fragment, null, visible ? import_react282.default.createElement(ScrollLock, null) : null, import_react282.default.createElement("div", {
    ref: node,
...
function Search({
  ...
  const overlayMarkup = visible ? import_react283.default.createElement(SearchDismissOverlay, {
    onDismiss,
    visible: overlayVisible
  }) : null;
  return import_react283.default.createElement(import_react283.default.Fragment, null, overlayMarkup, import_react283.default.createElement("div", {
...
function SearchField3({
  ...
  const i18n = useI18n();
  const [forceActive, setForceActive] = (0, import_react284.useState)(false);
  const input = (0, import_react284.useRef)(null);
  const searchId = (0, import_react284.useId)();
  const handleChange = (0, import_react284.useCallback)(({
    currentTarget
  }) => {
    onChange(currentTarget.value);
  }, [onChange]);
  const handleFocus = (0, import_react284.useCallback)(() => onFocus && onFocus(), [onFocus]);
  const handleBlur = (0, import_react284.useCallback)(() => onBlur && onBlur(), [onBlur]);
  const handleClear = (0, import_react284.useCallback)(() => {
    onCancel && onCancel();
    if (!input.current) {
      return;
    }
  ...
  const clearMarkup = value !== "" && import_react284.default.createElement("button", {
    type: "button",
  ...
  }, import_react284.default.createElement(Icon, {
    source: SvgXCircleIcon
  }));
  ...
  return import_react284.default.createElement("div", {
    ...
    onFocus: handleFocus,
    onBlur: handleBlur
  }, import_react284.default.createElement(Text, {
    as: "span",
    visuallyHidden: true
  }, import_react284.default.createElement("label", {
    htmlFor: searchId
  }, i18n.translate("Polaris.TopBar.SearchField.search"))), import_react284.default.createElement("input", {
    id: searchId,
  ...
  }), import_react284.default.createElement("span", {
    className: styles126.Icon
  }, import_react284.default.createElement(Icon, {
    source: SvgSearchIcon
  })), clearMarkup, import_react284.default.createElement("div", {
...
function MessageIndicator({
  ...
  const indicatorMarkup = active && import_react285.default.createElement("div", {
...
function Message({
  ...
  const badgeMarkup = badge && import_react286.default.createElement(Badge, {
    tone: badge.tone
  }, badge.content);
  const {
    to,
  ...
  }, import_react286.default.createElement(Popover2.Section, null, import_react286.default.createElement(LegacyStack, {
    vertical: true,
    spacing: "tight"
  }, import_react286.default.createElement(TextContainer, null, import_react286.default.createElement(Text, {
    variant: "headingMd",
    as: "h2"
  }, title, badgeMarkup), import_react286.default.createElement("p", null, description)), import_react286.default.createElement(Link, {
    url: to
  }, linkContent), import_react286.default.createElement(Button, {
    variant: "plain",
    onClick
  }, actionContent))));
}
...
function Menu(props) {
  ...
  const messageMarkup = message && import_react287.default.createElement(Message, {
    title: message.title,
  ...
  return import_react287.default.createElement(Popover2, {
    activator: import_react287.default.createElement("div", {
      className: styles129.ActivatorWrapper
    }, import_react287.default.createElement("button", {
      type: "button",
    ...
    fullHeight: true,
    preferredAlignment: "right"
  }, import_react287.default.createElement("div", {
    className: styles129.MenuItems
  }, import_react287.default.createElement(Box, {
    width: customWidth
  }, import_react287.default.createElement(ActionList, {
    actionRole: "menuitem",
...
function UserMenu({
  ...
  const activatorContentMarkup = customActivator ? customActivator : import_react288.default.createElement(import_react288.default.Fragment, null, import_react288.default.createElement("span", {
    className: styles127.Details
  }, import_react288.default.createElement(Text, {
    as: "p",
    variant: "bodySm",
    alignment: "start",
    fontWeight: "medium",
    truncate: true
  }, name), import_react288.default.createElement("span", {
    ...
    truncate: true
  }, detail))), import_react288.default.createElement(MessageIndicator, {
    active: showIndicator
  }, import_react288.default.createElement(Avatar, {
    size: "md",
    initials: initials && initials.replace(" ", ""),
    source: avatar,
    name
  })));
  return import_react288.default.createElement(Menu, {
...
var TopBar = function TopBar2({
  ...
  const navigationButtonMarkup = showNavigationToggle ? import_react289.default.createElement("button", {
    type: "button",
    className: iconClassName,
  ...
  }, import_react289.default.createElement(Icon, {
    source: SvgMenuIcon
  }))) : null;
  const width = getWidth(logo, 104);
  let contextMarkup;
  if (contextControl) {
    contextMarkup = import_react289.default.createElement("div", {
    ...
    contextMarkup = import_react289.default.createElement("div", {
      className
    }, import_react289.default.createElement(UnstyledLink, {
      url: logo.url || "",
      className: styles123.LogoLink,
      style: {
        width
      }
    }, import_react289.default.createElement(Image, {
      source: logo.topBarSource || "",
      alt: logo.accessibilityLabel || "",
  ...
  const searchMarkup = searchField ? import_react289.default.createElement(import_react289.default.Fragment, null, searchField, import_react289.default.createElement(Search, {
    visible: searchResultsVisible,
    onDismiss: onSearchResultsDismiss,
    overlayVisible: searchResultsOverlayVisible
  }, searchResults)) : null;
  return import_react289.default.createElement("div", {
    className: styles123.TopBar
  }, import_react289.default.createElement("div", {
    className: styles123.Container
  }, import_react289.default.createElement("div", {
    className: styles123.LeftContent
  }, navigationButtonMarkup, contextMarkup), import_react289.default.createElement("div", {
    className: styles123.Search
  }, searchMarkup), import_react289.default.createElement("div", {
...
function unstyledButtonFrom({
  ...
  return import_react290.default.createElement(UnstyledButton, Object.assign({
    key,
    onClick: onAction
  }, action, overrides), content);
}
...
function VideoThumbnail({
  ...
  const timeStampMarkup = videoLength ? import_react291.default.createElement("div", {
    className: styles131.Timestamp
  }, import_react291.default.createElement(LegacyStack, {
    alignment: "center",
    spacing: "extraTight"
  ...
  if (showVideoProgress) {
    ...
    progressMarkup = import_react291.default.createElement("div", {
      className: styles131.Progress
    }, import_react291.default.createElement("progress", {
  ...
  }), import_react291.default.createElement("button", {
    type: "button",
...
function useRowHovered() {
  const hovered = (0, import_react292.useContext)(RowHoveredContext);
  return hovered;
}
function useRowSelected() {
  const {
    selected
  } = (0, import_react292.useContext)(RowContext);
  return selected;
}
function useContainerScroll() {
  const scrolledContainerRef = (0, import_react292.useContext)(ScrollContext);
