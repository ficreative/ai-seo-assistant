...
//#region node_modules/@shopify/polaris-tokens/dist/esm/_virtual/_rollupPluginBabelHelpers.mjs
...
//#endregion
//#region node_modules/@shopify/polaris-tokens/dist/esm/src/utils.mjs
...
function toEm(value, fontSize) {
	if (value === void 0) value = "";
	if (fontSize === void 0) fontSize = BASE_FONT_SIZE;
	var unit = getUnit(value);
	if (!unit) return value;
...
function tokenGroupToRems(metaTokenGroup) {
	return Object.fromEntries(Object.entries(metaTokenGroup).map(function(_ref) {
		...
		return [tokenName, Object.assign(Object.assign({}, tokenProperties), {}, { value: rem(tokenProperties.value) })];
	}));
}
...
function getMediaConditions(breakpoints) {
	...
	return Object.fromEntries(breakpointEntries.map(function(entry, index) {
		var _ref4 = _slicedToArray(entry, 2), breakpointsTokenName = _ref4[0], breakpoint = _ref4[1];
		var upMediaCondition = getUpMediaCondition(breakpoint);
		return [breakpointsTokenName, {
			up: upMediaCondition,
			down: getDownMediaCondition(breakpoint),
			only: index === lastBreakpointIndex ? upMediaCondition : upMediaCondition + " and " + getDownMediaCondition(breakpointEntries[index + 1][1])
		}];
	}));
}
...
function getDownMediaCondition(breakpoint) {
	var _toPx2;
	return "(max-width: " + toEm(parseFloat((_toPx2 = toPx(breakpoint)) != null ? _toPx2 : "") - .04 + "px") + ")";
}
...
//#endregion
//#region node_modules/@shopify/polaris-tokens/dist/esm/src/size.mjs
var size = {
	"0": "0px",
	"0165": "0.66px",
	"025": "1px",
...
//#endregion
//#region node_modules/@shopify/polaris-tokens/dist/esm/src/themes/base/border.mjs
var border = {
...
//#endregion
//#region node_modules/@shopify/polaris-tokens/dist/esm/src/themes/base/breakpoints.mjs
...
//#endregion
//#region node_modules/@shopify/polaris-tokens/dist/esm/src/colors.mjs
var gray = {
...
//#endregion
//#region node_modules/@shopify/polaris-tokens/dist/esm/src/themes/base/color.mjs
var color = {
	...
	"color-avatar-bg-fill": { value: gray[11] },
	"color-avatar-five-bg-fill": { value: rose[11] },
	"color-avatar-five-text-on-bg-fill": { value: rose[2] },
	"color-avatar-four-bg-fill": { value: azure[10] },
	"color-avatar-four-text-on-bg-fill": { value: azure[16] },
	"color-avatar-one-bg-fill": { value: magenta[12] },
	"color-avatar-one-text-on-bg-fill": { value: magenta[3] },
	"color-avatar-seven-bg-fill": { value: purple[11] },
	"color-avatar-seven-text-on-bg-fill": { value: purple[2] },
	"color-avatar-six-bg-fill": { value: lime[9] },
	"color-avatar-six-text-on-bg-fill": { value: lime[15] },
	"color-avatar-text-on-bg-fill": { value: gray[1] },
	"color-avatar-three-bg-fill": { value: teal[9] },
	"color-avatar-three-text-on-bg-fill": { value: teal[15] },
	"color-avatar-two-bg-fill": { value: green[7] },
	"color-avatar-two-text-on-bg-fill": { value: green[14] },
	"color-backdrop-bg": { value: blackAlpha[14] },
	"color-button-gradient-bg-fill": { value: "linear-gradient(180deg, rgba(48, 48, 48, 0) 63.53%, rgba(255, 255, 255, 0.15) 100%)" },
	"color-checkbox-bg-surface-disabled": { value: blackAlpha[7] },
	"color-checkbox-icon-disabled": { value: gray[1] },
	"color-input-bg-surface": { value: gray[2] },
	"color-input-bg-surface-hover": { value: gray[3] },
	"color-input-bg-surface-active": { value: gray[4] },
	"color-input-border": { value: gray[12] },
	"color-input-border-hover": { value: gray[13] },
	"color-input-border-active": { value: gray[16] },
	"color-nav-bg": { value: gray[7] },
	"color-nav-bg-surface": { value: blackAlpha[3] },
	"color-nav-bg-surface-hover": { value: gray[6] },
	"color-nav-bg-surface-active": { value: gray[3] },
	"color-nav-bg-surface-selected": { value: gray[3] },
	"color-radio-button-bg-surface-disabled": { value: blackAlpha[7] },
	"color-radio-button-icon-disabled": { value: gray[1] },
	"color-video-thumbnail-play-button-bg-fill-hover": { value: blackAlpha[15] },
	"color-video-thumbnail-play-button-bg-fill": { value: blackAlpha[14] },
	"color-video-thumbnail-play-button-text-on-bg-fill": { value: gray[1] },
	"color-scrollbar-thumb-bg-hover": { value: gray[12] },
	"color-scrollbar-thumb-bg": { value: gray[11] }
};
//#endregion
//#region node_modules/@shopify/polaris-tokens/dist/esm/src/themes/base/font.mjs
var font = {
	...
	"font-size-300": { value: size[300] },
	"font-size-325": { value: size[325] },
	"font-size-350": { value: size[350] },
	"font-size-400": { value: size[400] },
	"font-size-450": { value: size[450] },
	"font-size-500": { value: size[500] },
	"font-size-550": { value: size[550] },
	"font-size-600": { value: size[600] },
	"font-size-750": { value: size[750] },
	"font-size-800": { value: size[800] },
	"font-size-900": { value: size[900] },
	"font-size-1000": { value: size[1e3] },
	...
	"font-line-height-1000": { value: size[1e3] },
	"font-line-height-1200": { value: size[1200] }
};
//#endregion
//#region node_modules/@shopify/polaris-tokens/dist/esm/src/themes/base/height.mjs
var height = {
	"height-0": { value: size[0] },
	"height-025": { value: size["025"] },
	"height-050": { value: size["050"] },
	"height-100": { value: size[100] },
	"height-150": { value: size[150] },
	"height-200": { value: size[200] },
	"height-300": { value: size[300] },
	"height-400": { value: size[400] },
	"height-500": { value: size[500] },
	"height-600": { value: size[600] },
	"height-700": { value: size[700] },
	"height-800": { value: size[800] },
	"height-900": { value: size[900] },
	"height-1000": { value: size[1e3] },
	"height-1200": { value: size[1200] },
	"height-1600": { value: size[1600] },
	"height-2000": { value: size[2e3] },
	"height-2400": { value: size[2400] },
	"height-2800": { value: size[2800] },
	"height-3200": { value: size[3200] }
};
//#endregion
//#region node_modules/@shopify/polaris-tokens/dist/esm/src/themes/base/motion.mjs
var motion = {
	...
	"motion-keyframes-bounce": { value: "{ from, 65%, 85% { transform: scale(1) } 75% { transform: scale(0.85) } 82.5% { transform: scale(1.05) } }" },
	...
	"motion-keyframes-appear-above": { value: "{ from { transform: translateY(var(--p-space-100)); opacity: 0; } to { transform: none; opacity: 1; } }" },
	"motion-keyframes-appear-below": { value: "{ from { transform: translateY(calc(var(--p-space-100) * -1)); opacity: 0; } to { transform: none; opacity: 1; } }" }
};
//#endregion
//#region node_modules/@shopify/polaris-tokens/dist/esm/src/themes/base/shadow.mjs
var shadow = {
	"shadow-0": { value: "none" },
	...
	"shadow-bevel-100": { value: "1px 0px 0px 0px rgba(0, 0, 0, 0.13) inset, -1px 0px 0px 0px rgba(0, 0, 0, 0.13) inset, 0px -1px 0px 0px rgba(0, 0, 0, 0.17) inset, 0px 1px 0px 0px rgba(204, 204, 204, 0.5) inset" },
	"shadow-inset-100": { value: "0px 1px 2px 0px rgba(26, 26, 26, 0.15) inset, 0px 1px 1px 0px rgba(26, 26, 26, 0.15) inset" },
	"shadow-inset-200": { value: "0px 2px 1px 0px rgba(26, 26, 26, 0.20) inset, 1px 0px 1px 0px rgba(26, 26, 26, 0.12) inset, -1px 0px 1px 0px rgba(26, 26, 26, 0.12) inset" },
	"shadow-button": { value: "0px -1px 0px 0px #b5b5b5 inset, 0px 0px 0px 1px rgba(0, 0, 0, 0.1) inset, 0px 0.5px 0px 1.5px #FFF inset" },
	"shadow-button-hover": { value: "0px 1px 0px 0px #EBEBEB inset, -1px 0px 0px 0px #EBEBEB inset, 1px 0px 0px 0px #EBEBEB inset, 0px -1px 0px 0px #CCC inset" },
	"shadow-button-inset": { value: "-1px 0px 1px 0px rgba(26, 26, 26, 0.122) inset, 1px 0px 1px 0px rgba(26, 26, 26, 0.122) inset, 0px 2px 1px 0px rgba(26, 26, 26, 0.2) inset" },
	"shadow-button-primary": { value: "0px -1px 0px 1px rgba(0, 0, 0, 0.8) inset, 0px 0px 0px 1px rgba(48, 48, 48, 1) inset, 0px 0.5px 0px 1.5px rgba(255, 255, 255, 0.25) inset" },
	"shadow-button-primary-hover": { value: "0px 1px 0px 0px rgba(255, 255, 255, 0.24) inset, 1px 0px 0px 0px rgba(255, 255, 255, 0.20) inset, -1px 0px 0px 0px rgba(255, 255, 255, 0.20) inset, 0px -1px 0px 0px #000 inset, 0px -1px 0px 1px #1A1A1A" },
	"shadow-button-primary-inset": { value: "0px 3px 0px 0px rgb(0, 0, 0) inset" },
	"shadow-button-primary-critical": { value: "0px -1px 0px 1px rgba(142, 31, 11, 0.8) inset, 0px 0px 0px 1px rgba(181, 38, 11, 0.8) inset, 0px 0.5px 0px 1.5px rgba(255, 255, 255, 0.349) inset" },
	"shadow-button-primary-critical-hover": { value: "0px 1px 0px 0px rgba(255, 255, 255, 0.48) inset, 1px 0px 0px 0px rgba(255, 255, 255, 0.20) inset, -1px 0px 0px 0px rgba(255, 255, 255, 0.20) inset, 0px -1.5px 0px 0px rgba(0, 0, 0, 0.25) inset" },
	"shadow-button-primary-critical-inset": { value: "-1px 0px 1px 0px rgba(0, 0, 0, 0.2) inset, 1px 0px 1px 0px rgba(0, 0, 0, 0.2) inset, 0px 2px 0px 0px rgba(0, 0, 0, 0.6) inset" },
	"shadow-button-primary-success": { value: "0px -1px 0px 1px rgba(12, 81, 50, 0.8) inset, 0px 0px 0px 1px rgba(19, 111, 69, 0.8) inset, 0px 0.5px 0px 1.5px rgba(255, 255, 255, 0.251) inset" },
	"shadow-button-primary-success-hover": { value: "0px 1px 0px 0px rgba(255, 255, 255, 0.48) inset, 1px 0px 0px 0px rgba(255, 255, 255, 0.20) inset, -1px 0px 0px 0px rgba(255, 255, 255, 0.20) inset, 0px -1.5px 0px 0px rgba(0, 0, 0, 0.25) inset" },
	"shadow-button-primary-success-inset": { value: "-1px 0px 1px 0px rgba(0, 0, 0, 0.2) inset, 1px 0px 1px 0px rgba(0, 0, 0, 0.2) inset, 0px 2px 0px 0px rgba(0, 0, 0, 0.6) inset" },
	"shadow-border-inset": { value: "0px 0px 0px 1px rgba(0, 0, 0, 0.08) inset" }
};
//#endregion
//#region node_modules/@shopify/polaris-tokens/dist/esm/src/themes/base/space.mjs
var space = {
	...
	"space-1000": { value: size[1e3] },
	"space-1200": { value: size[1200] },
	"space-1600": { value: size[1600] },
	"space-2000": { value: size[2e3] },
	"space-2400": { value: size[2400] },
	"space-2800": { value: size[2800] },
	"space-3200": { value: size[3200] },
	"space-button-group-gap": { value: createVar("space-200") },
	"space-card-gap": { value: createVar("space-400") },
	"space-card-padding": { value: createVar("space-400") },
	"space-table-cell-padding": { value: createVar("space-150") }
};
function createVar(spaceTokenName) {
	return "var(" + createVarName(spaceTokenName) + ")";
}
//#endregion
//#region node_modules/@shopify/polaris-tokens/dist/esm/src/themes/base/index.mjs
var metaThemeBase = createMetaThemeBase({
	...
	space,
	text: {
		"text-heading-3xl-font-family": { value: createVar$1("font-family-sans") },
		"text-heading-3xl-font-size": { value: createVar$1("font-size-900") },
		"text-heading-3xl-font-weight": { value: createVar$1("font-weight-bold") },
		"text-heading-3xl-font-letter-spacing": { value: createVar$1("font-letter-spacing-densest") },
		"text-heading-3xl-font-line-height": { value: createVar$1("font-line-height-1200") },
		"text-heading-2xl-font-family": { value: createVar$1("font-family-sans") },
		"text-heading-2xl-font-size": { value: createVar$1("font-size-750") },
		"text-heading-2xl-font-weight": { value: createVar$1("font-weight-bold") },
		"text-heading-2xl-font-letter-spacing": { value: createVar$1("font-letter-spacing-denser") },
		"text-heading-2xl-font-line-height": { value: createVar$1("font-line-height-1000") },
		"text-heading-xl-font-family": { value: createVar$1("font-family-sans") },
		"text-heading-xl-font-size": { value: createVar$1("font-size-600") },
		"text-heading-xl-font-weight": { value: createVar$1("font-weight-bold") },
		"text-heading-xl-font-letter-spacing": { value: createVar$1("font-letter-spacing-dense") },
		"text-heading-xl-font-line-height": { value: createVar$1("font-line-height-800") },
		"text-heading-lg-font-family": { value: createVar$1("font-family-sans") },
		"text-heading-lg-font-size": { value: createVar$1("font-size-500") },
		"text-heading-lg-font-weight": { value: createVar$1("font-weight-semibold") },
		"text-heading-lg-font-letter-spacing": { value: createVar$1("font-letter-spacing-dense") },
		"text-heading-lg-font-line-height": { value: createVar$1("font-line-height-600") },
		"text-heading-md-font-family": { value: createVar$1("font-family-sans") },
		"text-heading-md-font-size": { value: createVar$1("font-size-350") },
		"text-heading-md-font-weight": { value: createVar$1("font-weight-semibold") },
		"text-heading-md-font-letter-spacing": { value: createVar$1("font-letter-spacing-normal") },
		"text-heading-md-font-line-height": { value: createVar$1("font-line-height-500") },
		"text-heading-sm-font-family": { value: createVar$1("font-family-sans") },
		"text-heading-sm-font-size": { value: createVar$1("font-size-325") },
		"text-heading-sm-font-weight": { value: createVar$1("font-weight-semibold") },
		"text-heading-sm-font-letter-spacing": { value: createVar$1("font-letter-spacing-normal") },
		"text-heading-sm-font-line-height": { value: createVar$1("font-line-height-500") },
		"text-heading-xs-font-family": { value: createVar$1("font-family-sans") },
		"text-heading-xs-font-size": { value: createVar$1("font-size-300") },
		"text-heading-xs-font-weight": { value: createVar$1("font-weight-semibold") },
		"text-heading-xs-font-letter-spacing": { value: createVar$1("font-letter-spacing-normal") },
		"text-heading-xs-font-line-height": { value: createVar$1("font-line-height-400") },
		"text-body-lg-font-family": { value: createVar$1("font-family-sans") },
		"text-body-lg-font-size": { value: createVar$1("font-size-350") },
		"text-body-lg-font-weight": { value: createVar$1("font-weight-regular") },
		"text-body-lg-font-letter-spacing": { value: createVar$1("font-letter-spacing-normal") },
		"text-body-lg-font-line-height": { value: createVar$1("font-line-height-500") },
		"text-body-md-font-family": { value: createVar$1("font-family-sans") },
		"text-body-md-font-size": { value: createVar$1("font-size-325") },
		"text-body-md-font-weight": { value: createVar$1("font-weight-regular") },
		"text-body-md-font-letter-spacing": { value: createVar$1("font-letter-spacing-normal") },
		"text-body-md-font-line-height": { value: createVar$1("font-line-height-500") },
		"text-body-sm-font-family": { value: createVar$1("font-family-sans") },
		"text-body-sm-font-size": { value: createVar$1("font-size-300") },
		"text-body-sm-font-weight": { value: createVar$1("font-weight-regular") },
		"text-body-sm-font-letter-spacing": { value: createVar$1("font-letter-spacing-normal") },
		"text-body-sm-font-line-height": { value: createVar$1("font-line-height-400") },
		"text-body-xs-font-family": { value: createVar$1("font-family-sans") },
		"text-body-xs-font-size": { value: createVar$1("font-size-275") },
		"text-body-xs-font-weight": { value: createVar$1("font-weight-regular") },
		"text-body-xs-font-letter-spacing": { value: createVar$1("font-letter-spacing-normal") },
		"text-body-xs-font-line-height": { value: createVar$1("font-line-height-300") }
	},
	width: {
		"width-0": { value: size[0] },
		"width-025": { value: size["025"] },
		"width-050": { value: size["050"] },
		"width-100": { value: size[100] },
		"width-150": { value: size[150] },
		"width-200": { value: size[200] },
		"width-300": { value: size[300] },
		"width-400": { value: size[400] },
		"width-500": { value: size[500] },
		"width-600": { value: size[600] },
		"width-700": { value: size[700] },
		"width-800": { value: size[800] },
		"width-900": { value: size[900] },
		"width-1000": { value: size[1e3] },
		"width-1200": { value: size[1200] },
		"width-1600": { value: size[1600] },
		"width-2000": { value: size[2e3] },
		"width-2400": { value: size[2400] },
		"width-2800": { value: size[2800] },
		"width-3200": { value: size[3200] }
	},
	zIndex: {
...
//#endregion
//#region node_modules/@shopify/polaris-tokens/dist/esm/src/themes/utils.mjs
/**
* Mimics the behavior of an identity function:
* - Validates the input matches the `MetaThemeShape` type exactly
* - Converts all `px` values to `rem`
...
function createMetaTheme(metaThemePartial) {
	return (0, import_cjs.default)(metaThemeBase, metaThemePartial);
}
...
//#endregion
//#region node_modules/@shopify/polaris-tokens/dist/esm/src/themes/constants.mjs
...
//#endregion
//#region node_modules/@shopify/polaris-tokens/dist/esm/src/themes/light.mjs
var metaThemeLightPartial = createMetaThemePartial({});
var metaThemeLight = createMetaTheme(metaThemeLightPartial);
//#endregion
//#region node_modules/@shopify/polaris-tokens/dist/esm/src/themes/light-high-contrast.mjs
var metaThemeLightHighContrastPartial = createMetaThemePartial({
	color: {
		"color-text": { value: gray[16] },
		"color-text-secondary": { value: gray[16] },
		"color-text-brand": { value: gray[16] },
		"color-icon-secondary": { value: gray[14] },
		"color-border": { value: gray[12] },
		"color-input-border": { value: gray[14] },
		"color-border-secondary": { value: gray[12] },
		"color-bg-surface-secondary": { value: gray[6] }
	},
	shadow: { "shadow-bevel-100": { value: "0px 1px 0px 0px rgba(26, 26, 26, 0.07), 0px 1px 0px 0px rgba(208, 208, 208, 0.40) inset, 1px 0px 0px 0px #CCC inset, -1px 0px 0px 0px #CCC inset, 0px -1px 0px 0px #999 inset" } }
});
var metaThemeLightHighContrast = createMetaTheme(metaThemeLightHighContrastPartial);
//#endregion
//#region node_modules/@shopify/polaris-tokens/dist/esm/src/themes/light-mobile.mjs
...
var metaThemeLightMobilePartial = createMetaThemePartial({
	...
	shadow: {
		...
		"shadow-button": { value: buttonShadow },
		"shadow-button-hover": { value: buttonShadow },
		"shadow-button-inset": { value: buttonShadow },
	...
	space: { "space-card-gap": { value: createVar$1("space-200") } },
	text: {
		"text-heading-2xl-font-size": { value: createVar$1("font-size-800") },
		"text-heading-xl-font-size": { value: createVar$1("font-size-550") },
		"text-heading-xl-font-line-height": { value: createVar$1("font-line-height-700") },
		"text-heading-lg-font-size": { value: createVar$1("font-size-450") },
		"text-heading-md-font-size": { value: createVar$1("font-size-400") },
		"text-heading-sm-font-size": { value: createVar$1("font-size-350") },
		"text-body-lg-font-size": { value: createVar$1("font-size-450") },
		"text-body-lg-font-line-height": { value: createVar$1("font-line-height-700") },
		"text-body-md-font-size": { value: createVar$1("font-size-400") },
		"text-body-md-font-line-height": { value: createVar$1("font-line-height-600") },
		"text-body-sm-font-size": { value: createVar$1("font-size-350") },
		"text-body-sm-font-line-height": { value: createVar$1("font-line-height-500") },
		"text-body-xs-font-size": { value: createVar$1("font-size-300") },
		"text-body-xs-font-line-height": { value: createVar$1("font-line-height-400") }
	}
});
var metaThemeLightMobile = createMetaTheme(metaThemeLightMobilePartial);
//#endregion
//#region node_modules/@shopify/polaris-tokens/dist/esm/src/themes/dark.mjs
var metaThemeDarkPartial = createMetaThemePartial({
	color: {
		"color-scheme": { value: "dark" },
		"color-bg": { value: gray[16] },
		"color-bg-surface": { value: gray[15] },
		"color-bg-fill": { value: gray[15] },
		"color-icon": { value: gray[8] },
		"color-icon-secondary": { value: gray[11] },
		"color-icon-disabled": { value: gray[14] },
		"color-text": { value: gray[8] },
		"color-text-secondary": { value: gray[11] },
		"color-text-disabled": { value: gray[14] },
		"color-bg-surface-secondary-active": { value: whiteAlpha[9] },
		"color-bg-surface-secondary-hover": { value: whiteAlpha[6] },
		"color-bg-fill-transparent": { value: whiteAlpha[8] },
		"color-bg-fill-brand": { value: gray[1] },
		"color-text-brand-on-bg-fill": { value: gray[15] },
		"color-bg-surface-hover": { value: gray[14] },
		"color-bg-fill-hover": { value: whiteAlpha[5] },
		"color-bg-fill-transparent-hover": { value: whiteAlpha[9] },
		"color-bg-fill-brand-hover": { value: gray[5] },
		"color-bg-surface-selected": { value: gray[13] },
		"color-bg-fill-selected": { value: gray[13] },
		"color-bg-fill-transparent-selected": { value: whiteAlpha[11] },
		"color-bg-fill-brand-selected": { value: gray[9] },
		"color-bg-surface-active": { value: gray[13] },
		"color-bg-fill-active": { value: gray[13] },
		"color-bg-fill-transparent-active": { value: whiteAlpha[10] },
		"color-bg-fill-brand-active": { value: gray[4] },
		"color-bg-fill-secondary": { value: whiteAlpha[7] },
		"color-bg-fill-secondary-hover": { value: whiteAlpha[8] },
		"color-bg-fill-secondary-selected": { value: whiteAlpha[10] },
		"color-bg-surface-brand-selected": { value: gray[14] },
		"color-border-secondary": { value: gray[14] },
		"color-bg-surface-tertiary": { value: whiteAlpha[7] },
		"color-icon-brand": { value: gray[14] },
		"color-bg-fill-disabled": { value: whiteAlpha[5] },
		"color-text-brand-on-bg-fill-disabled": { value: gray[12] },
		"color-bg-fill-brand-disabled": { value: whiteAlpha[11] },
		"color-bg-fill-tertiary": { value: gray[15] },
		"color-tooltip-tail-down-border": { value: "rgba(60, 60, 60, 1)" },
		"color-tooltip-tail-up-border": { value: "rgba(71, 71, 71, 1)" }
	},
	shadow: { "shadow-bevel-100": { value: "1px 0px 0px 0px rgba(204, 204, 204, 0.08) inset, -1px 0px 0px 0px rgba(204, 204, 204, 0.08) inset, 0px -1px 0px 0px rgba(204, 204, 204, 0.08) inset, 0px 1px 0px 0px rgba(204, 204, 204, 0.16) inset" } }
});
//#endregion
//#region node_modules/@shopify/polaris-tokens/dist/esm/src/themes/index.mjs
var metaThemes = {
	light: metaThemeLight,
	"light-mobile": metaThemeLightMobile,
	"light-high-contrast-experimental": metaThemeLightHighContrast,
	"dark-experimental": createMetaTheme(metaThemeDarkPartial)
};
...
//#endregion
//#region node_modules/@shopify/polaris-tokens/dist/esm/build/index.mjs
var themes = {
	"light": {
		"border": {
...
//#endregion
export { metaThemes as a, createThemeClassName as c, createVarName as d, getMediaConditions as f, toRem as g, toPxs as h, metaThemeDefault as i, breakpointsAliases as l, toPx as m, themeDefault as n, themeNameDefault as o, getThemeVarNames as p, themes as r, themeNames as s, isTokenName as t, createVar$1 as u };

//# sourceMappingURL=build-BNKABl-0.js.map